...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSXPCConnectionCodeSigningRequirementFailure"] = @4102L;
	...
	context[@"NSCompressionFailedError"] = @5376L;
	context[@"NSDecompressionFailedError"] = @5377L;
	context[@"NSCompressionErrorMinimum"] = @5376L;
	context[@"NSCompressionErrorMaximum"] = @5503L;
