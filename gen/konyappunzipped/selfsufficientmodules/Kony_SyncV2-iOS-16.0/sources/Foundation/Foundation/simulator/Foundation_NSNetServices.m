...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSNetServicesMissingRequiredConfigurationError"] = @-72008L;
...
{
	(void)objc_getProtocol('NSNetServiceDelegate');
	(void)objc_getProtocol('NSNetServiceBrowserDelegate');
}
