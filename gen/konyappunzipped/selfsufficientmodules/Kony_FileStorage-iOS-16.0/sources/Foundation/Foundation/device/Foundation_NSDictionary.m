...
static void addProtocols()
{
	...
	class_addProtocol([NSDictionary class], @protocol(NSDictionaryNSGenericFastEnumerationCategoryInstanceExports));
	class_addProtocol([NSDictionary class], @protocol(NSDictionaryNSGenericFastEnumerationCategoryClassExports));
}
