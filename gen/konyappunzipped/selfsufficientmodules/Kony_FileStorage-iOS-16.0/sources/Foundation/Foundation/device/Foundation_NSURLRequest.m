...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSURLNetworkServiceTypeResponsiveData"] = @6U;
	context[@"NSURLNetworkServiceTypeAVStreaming"] = @8U;
	context[@"NSURLNetworkServiceTypeResponsiveAV"] = @9U;
	context[@"NSURLNetworkServiceTypeCallSignaling"] = @11U;


	context[@"NSURLRequestAttributionDeveloper"] = @0U;
	context[@"NSURLRequestAttributionUser"] = @1U;
