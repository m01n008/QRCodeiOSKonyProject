...
-(id) jsinitWithValidatedFormat: (NSString *) format validFormatSpecifiers: (NSString *) validFormatSpecifiers error: (JSValue *) error arguments: (NSArray *) args 
{
	NSError* error_ = nil;
	id resultVal__;
	if ([args count] == 0) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ ] autorelease];
	else if ([args count] == 1) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0]] autorelease];
	else if ([args count] == 2) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1]] autorelease];
	else if ([args count] == 3) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2]] autorelease];
	else if ([args count] == 4) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3]] autorelease];
	else if ([args count] == 5) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4]] autorelease];
	else if ([args count] == 6) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5]] autorelease];
	else if ([args count] == 7) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6]] autorelease];
	else if ([args count] == 8) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]] autorelease];
	else if ([args count] == 9) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]] autorelease];
	else if ([args count] >= 10) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9]] autorelease];
	if (error_ && [error isObject]) {
		error[@"error"] = error_;
	}
	return resultVal__;
...
-(id) jsinitWithValidatedFormat: (NSString *) format validFormatSpecifiers: (NSString *) validFormatSpecifiers locale: (id) locale error: (JSValue *) error arguments: (NSArray *) args 
{
	NSError* error_ = nil;
	id resultVal__;
	if ([args count] == 0) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ ] autorelease];
	else if ([args count] == 1) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0]] autorelease];
	else if ([args count] == 2) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1]] autorelease];
	else if ([args count] == 3) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1], args[2]] autorelease];
	else if ([args count] == 4) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1], args[2], args[3]] autorelease];
	else if ([args count] == 5) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1], args[2], args[3], args[4]] autorelease];
	else if ([args count] == 6) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5]] autorelease];
	else if ([args count] == 7) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6]] autorelease];
	else if ([args count] == 8) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]] autorelease];
	else if ([args count] == 9) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]] autorelease];
	else if ([args count] >= 10) resultVal__ = [[self initWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers locale: locale error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9]] autorelease];
	if (error_ && [error isObject]) {
		error[@"error"] = error_;
	}
	return resultVal__;
...
+(id) jsstringWithValidatedFormat: (NSString *) format validFormatSpecifiers: (NSString *) validFormatSpecifiers error: (JSValue *) error arguments: (NSArray *) args 
{
	NSError* error_ = nil;
	id resultVal__;
	if ([args count] == 0) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ ];
	else if ([args count] == 1) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0]];
	else if ([args count] == 2) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1]];
	else if ([args count] == 3) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2]];
	else if ([args count] == 4) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3]];
	else if ([args count] == 5) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4]];
	else if ([args count] == 6) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5]];
	else if ([args count] == 7) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6]];
	else if ([args count] == 8) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]];
	else if ([args count] == 9) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]];
	else if ([args count] >= 10) resultVal__ = [self stringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9]];
	if (error_ && [error isObject]) {
		error[@"error"] = error_;
	}
	return resultVal__;
...
+(id) jslocalizedStringWithValidatedFormat: (NSString *) format validFormatSpecifiers: (NSString *) validFormatSpecifiers error: (JSValue *) error arguments: (NSArray *) args 
{
	NSError* error_ = nil;
	id resultVal__;
	if ([args count] == 0) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ ];
	else if ([args count] == 1) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0]];
	else if ([args count] == 2) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1]];
	else if ([args count] == 3) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2]];
	else if ([args count] == 4) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3]];
	else if ([args count] == 5) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4]];
	else if ([args count] == 6) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5]];
	else if ([args count] == 7) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6]];
	else if ([args count] == 8) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]];
	else if ([args count] == 9) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]];
	else if ([args count] >= 10) resultVal__ = [self localizedStringWithValidatedFormat: format validFormatSpecifiers: validFormatSpecifiers error: &error_ , args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9]];
	if (error_ && [error isObject]) {
		error[@"error"] = error_;
	}
	return resultVal__;
...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSStringEnumerationByCaretPositions"] = @5UL;
	context[@"NSStringEnumerationByDeletionClusters"] = @6UL;
