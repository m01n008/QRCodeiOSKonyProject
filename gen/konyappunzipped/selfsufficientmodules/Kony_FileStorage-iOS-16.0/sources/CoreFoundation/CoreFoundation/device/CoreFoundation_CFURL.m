...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"kCFURLBookmarkCreationWithoutImplicitSecurityScope"] = @536870912UL;
	...
	context[@"kCFURLBookmarkResolutionWithoutImplicitStartAccessing"] = @32768UL;
...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &kCFURLFileContentIdentifierKey;
	if (p != NULL) context[@"kCFURLFileContentIdentifierKey"] = [JSValue valueWithObject: (__bridge id) kCFURLFileContentIdentifierKey inContext: context];
	p = (void*) &kCFURLMayShareFileContentKey;
	if (p != NULL) context[@"kCFURLMayShareFileContentKey"] = [JSValue valueWithObject: (__bridge id) kCFURLMayShareFileContentKey inContext: context];
	p = (void*) &kCFURLMayHaveExtendedAttributesKey;
	if (p != NULL) context[@"kCFURLMayHaveExtendedAttributesKey"] = [JSValue valueWithObject: (__bridge id) kCFURLMayHaveExtendedAttributesKey inContext: context];
	p = (void*) &kCFURLIsPurgeableKey;
	if (p != NULL) context[@"kCFURLIsPurgeableKey"] = [JSValue valueWithObject: (__bridge id) kCFURLIsPurgeableKey inContext: context];
	p = (void*) &kCFURLIsSparseKey;
	if (p != NULL) context[@"kCFURLIsSparseKey"] = [JSValue valueWithObject: (__bridge id) kCFURLIsSparseKey inContext: context];
	...
	p = (void*) &kCFURLVolumeSupportsFileProtectionKey;
	if (p != NULL) context[@"kCFURLVolumeSupportsFileProtectionKey"] = [JSValue valueWithObject: (__bridge id) kCFURLVolumeSupportsFileProtectionKey inContext: context];
	...
	p = (void*) &kCFURLUbiquitousItemIsExcludedFromSyncKey;
	if (p != NULL) context[@"kCFURLUbiquitousItemIsExcludedFromSyncKey"] = [JSValue valueWithObject: (__bridge id) kCFURLUbiquitousItemIsExcludedFromSyncKey inContext: context];
