...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"errSecRestrictedAPI"] = @-34020;
	...
	context[@"errSecInvalidCRLAuthority"] = @-67827;
	...
	context[@"errSecInvalidTupleCredentials"] = @-67852;
	...
	context[@"errSecCertificatePolicyNotAllowed"] = @-67899;
	context[@"errSecCertificateNameNotAllowed"] = @-67900;
	context[@"errSecCertificateValidityPeriodTooLong"] = @-67901;
	context[@"errSecCertificateIsCA"] = @-67902;
	context[@"errSecCertificateDuplicateExtension"] = @-67903;
	...
	context[@"errSSLTransportReset"] = @-9852;
	context[@"errSSLNetworkTimeout"] = @-9853;
	context[@"errSSLConfigurationFailed"] = @-9854;
	context[@"errSSLUnsupportedExtension"] = @-9855;
	context[@"errSSLUnexpectedMessage"] = @-9856;
	context[@"errSSLDecompressFail"] = @-9857;
	context[@"errSSLHandshakeFail"] = @-9858;
	context[@"errSSLDecodeError"] = @-9859;
	context[@"errSSLInappropriateFallback"] = @-9860;
	context[@"errSSLMissingExtension"] = @-9861;
	context[@"errSSLBadCertificateStatusResponse"] = @-9862;
	context[@"errSSLCertificateRequired"] = @-9863;
	context[@"errSSLUnknownPSKIdentity"] = @-9864;
	context[@"errSSLUnrecognizedName"] = @-9865;
	context[@"errSSLATSViolation"] = @-9880;
	context[@"errSSLATSMinimumVersionViolation"] = @-9881;
	context[@"errSSLATSCiphersuiteViolation"] = @-9882;
	context[@"errSSLATSMinimumKeySizeViolation"] = @-9883;
	context[@"errSSLATSLeafCertificateHashAlgorithmViolation"] = @-9884;
	context[@"errSSLATSCertificateHashAlgorithmViolation"] = @-9885;
	context[@"errSSLATSCertificateTrustViolation"] = @-9886;
	context[@"errSSLEarlyDataRejected"] = @-9890;
