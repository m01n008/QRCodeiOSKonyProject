...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSXPCConnectionCodeSigningRequirementFailure"] = @4102;
	...
	context[@"NSCompressionFailedError"] = @5376;
	context[@"NSDecompressionFailedError"] = @5377;
	context[@"NSCompressionErrorMinimum"] = @5376;
	context[@"NSCompressionErrorMaximum"] = @5503;
