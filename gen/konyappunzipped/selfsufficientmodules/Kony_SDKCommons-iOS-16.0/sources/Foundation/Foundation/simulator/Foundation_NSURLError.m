...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSURLErrorNetworkUnavailableReasonCellular"] = @0L;
	context[@"NSURLErrorNetworkUnavailableReasonExpensive"] = @1L;
	context[@"NSURLErrorNetworkUnavailableReasonConstrained"] = @2L;
...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &NSURLErrorNetworkUnavailableReasonKey;
	if (p != NULL) context[@"NSURLErrorNetworkUnavailableReasonKey"] = NSURLErrorNetworkUnavailableReasonKey;
}
