...
{
	context[@"UICollectionElementCategoryCell"] = @0U;
	context[@"UICollectionElementCategorySupplementaryView"] = @1U;
	context[@"UICollectionElementCategoryDecorationView"] = @2U;

	context[@"UICollectionUpdateActionInsert"] = @0;
	context[@"UICollectionUpdateActionDelete"] = @1;
	context[@"UICollectionUpdateActionReload"] = @2;
	context[@"UICollectionUpdateActionMove"] = @3;
	context[@"UICollectionUpdateActionNone"] = @4;
