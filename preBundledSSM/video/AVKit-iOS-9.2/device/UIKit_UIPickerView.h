...
@protocol UIPickerViewInstanceExports<JSExport, NSCodingInstanceExports_, UITableViewDataSourceInstanceExports_>
...
@end
@protocol UIPickerViewClassExports<JSExport, NSCodingClassExports_, UITableViewDataSourceClassExports_>
@end
