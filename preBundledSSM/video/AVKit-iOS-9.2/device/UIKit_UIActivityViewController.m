...
{
	void (^ value_)(NSString * , BOOL, NSArray * , NSError * ) = nil;
	if (!value.isUndefined) {
		value_ = ^void(NSString * arg0, BOOL arg1, NSArray * arg2, NSError * arg3) {
...
{
	void (^ value_)(NSString * , BOOL) = nil;
	if (!value.isUndefined) {
		value_ = ^void(NSString * arg0, BOOL arg1) {
			JSContext* __jsContext = value.context;
			NSMutableArray* parameters = [NSMutableArray array];
			[parameters addObject: (arg0 ? [JSValue valueWithObject: arg0 inContext: __jsContext] : [JSValue valueWithUndefinedInContext: __jsContext])];
			[parameters addObject: [JSValue valueWithObject: @(arg1) inContext: __jsContext]];
