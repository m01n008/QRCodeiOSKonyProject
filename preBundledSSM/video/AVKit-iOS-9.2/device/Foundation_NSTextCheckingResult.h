...
@end
@protocol NSTextCheckingResultInstanceExports<JSExport, NSCopyingInstanceExports_, NSCodingInstanceExports_>
@property (readonly) NSTextCheckingType resultType;
@property (readonly) NSRange range;
@end
@protocol NSTextCheckingResultClassExports<JSExport, NSCopyingClassExports_, NSCodingClassExports_>
@end
