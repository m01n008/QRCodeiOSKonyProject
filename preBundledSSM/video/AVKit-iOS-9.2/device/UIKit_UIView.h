...
@end
@protocol UIViewInstanceExports<JSExport, NSCodingInstanceExports_, UIAppearanceInstanceExports_, UIAppearanceContainerInstanceExports_, UIDynamicItemInstanceExports_, UITraitEnvironmentInstanceExports_, UICoordinateSpaceInstanceExports_, UIFocusEnvironmentInstanceExports_>
...
@end
@protocol UIViewClassExports<JSExport, NSCodingClassExports_, UIAppearanceClassExports_, UIAppearanceContainerClassExports_, UIDynamicItemClassExports_, UITraitEnvironmentClassExports_, UICoordinateSpaceClassExports_, UIFocusEnvironmentClassExports_>
