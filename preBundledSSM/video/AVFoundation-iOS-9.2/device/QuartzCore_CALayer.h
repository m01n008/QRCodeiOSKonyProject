...
@protocol NSObjectCALayerDelegateCategoryInstanceExports<JSExport>
-(void) drawLayer: (CALayer *) layer inContext: (id) ctx ;
-(id) actionForLayer: (CALayer *) layer forKey: (NSString *) event ;
-(void) displayLayer: (CALayer *) layer ;
-(void) layoutSublayersOfLayer: (CALayer *) layer ;
@end
@protocol NSObjectCALayerDelegateCategoryClassExports<JSExport>
@end
@protocol CALayerInstanceExports<JSExport, NSCodingInstanceExports_, CAMediaTimingInstanceExports_>
...
@end
@protocol CALayerClassExports<JSExport, NSCodingClassExports_, CAMediaTimingClassExports_>
