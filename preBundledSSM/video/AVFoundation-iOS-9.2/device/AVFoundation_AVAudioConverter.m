...
@implementation JSValue (AVFoundation_AVAudioConverter)
...
{
	context[@"AVAudioConverterPrimeMethod_Pre"] = @0;
	context[@"AVAudioConverterPrimeMethod_Normal"] = @1;
	context[@"AVAudioConverterPrimeMethod_None"] = @2;

	context[@"AVAudioConverterInputStatus_HaveData"] = @0;
	context[@"AVAudioConverterInputStatus_NoDataNow"] = @1;
	context[@"AVAudioConverterInputStatus_EndOfStream"] = @2;

	context[@"AVAudioConverterOutputStatus_HaveData"] = @0;
	context[@"AVAudioConverterOutputStatus_InputRanDry"] = @1;
	context[@"AVAudioConverterOutputStatus_EndOfStream"] = @2;
	context[@"AVAudioConverterOutputStatus_Error"] = @3;
...
void load_AVFoundation_AVAudioConverter_symbols(JSContext* context)
{
    addProtocols();
