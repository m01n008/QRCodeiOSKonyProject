...
{
	context[@"AVAudioQualityMin"] = @0;
	context[@"AVAudioQualityLow"] = @32;
	context[@"AVAudioQualityMedium"] = @64;
	context[@"AVAudioQualityHigh"] = @96;
	context[@"AVAudioQualityMax"] = @127;
...
void load_AVFoundation_AVAudioSettings_symbols(JSContext* context)
{
    addProtocols();
