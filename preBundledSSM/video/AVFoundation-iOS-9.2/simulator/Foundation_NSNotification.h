...
-(id) jsaddObserverForName: (NSString *) name object: (id) obj queue: (NSOperationQueue *) queue usingBlock: (JSValue *) block );
-(void) postNotification: (NSNotification *) notification ;
JSExportAs(addObserverSelectorNameObject,
-(void) jsaddObserver: (id) observer selector: (NSString *) aSelector name: (NSString *) aName object: (id) anObject );
...
-(id) jsinitWithName: (NSString *) name object: (id) object userInfo: (NSDictionary *) userInfo );
