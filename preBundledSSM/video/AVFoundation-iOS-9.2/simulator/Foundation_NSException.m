...
-(id) jsinitWithName: (NSString *) aName reason: (NSString *) aReason userInfo: (NSDictionary *) aUserInfo 
{
	id resultVal__;
...
+(void) jsraise: (NSString *) name format: (NSString *) format arguments: (NSArray *) args 
{
