...
@implementation JSValue (AVFoundation_AVAudioSequencer)
...
{
	context[@"AVMusicSequenceLoadSMF_PreserveTracks"] = @0U;
	context[@"AVMusicSequenceLoadSMF_ChannelsToTracks"] = @1U;

	context[@"AVMusicTrackLoopCountForever"] = @-1;
...
void load_AVFoundation_AVAudioSequencer_symbols(JSContext* context)
{
    addProtocols();
