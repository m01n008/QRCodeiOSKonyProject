...
{
	void (^ block_)(NSDictionary<NSString *,id> * , NSRange, BOOL * ) = nil;
...
-(void) jsenumerateAttribute: (NSString *) attrName inRange: (NSRange) enumerationRange options: (NSAttributedStringEnumerationOptions) opts usingBlock: (JSValue *) block 
{
