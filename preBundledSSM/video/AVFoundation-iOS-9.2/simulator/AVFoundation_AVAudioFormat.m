...
{
	context[@"AVAudioOtherFormat"] = @0U;
	context[@"AVAudioPCMFormatFloat32"] = @1U;
	context[@"AVAudioPCMFormatFloat64"] = @2U;
	context[@"AVAudioPCMFormatInt16"] = @3U;
	context[@"AVAudioPCMFormatInt32"] = @4U;
...
void load_AVFoundation_AVAudioFormat_symbols(JSContext* context)
{
    addProtocols();
