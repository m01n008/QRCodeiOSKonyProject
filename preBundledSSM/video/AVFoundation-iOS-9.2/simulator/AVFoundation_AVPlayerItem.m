...
static void addProtocols()
{
	...
	class_addProtocol([AVPlayerItem class], @protocol(AVPlayerItemAVPlayerItemBitRateControlCategoryInstanceExports));
	class_addProtocol([AVPlayerItem class], @protocol(AVPlayerItemAVPlayerItemBitRateControlCategoryClassExports));
