...
static void registerCFunctions(JSContext* context)
{
	...
	context[@"CTFontCreateForStringWithLanguage"] = ^id(id arg0, id arg1, CFRange arg2, id arg3) {
		return CTFontCreateForStringWithLanguage(arg0, arg1, arg2, arg3);
	};
	...
	context[@"CTFontCopyNameForGlyph"] = ^id(id arg0, CGGlyph arg1) {
		return CTFontCopyNameForGlyph(arg0, arg1);
	};
...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &kCTFontFeatureSampleTextKey;
	if (p != NULL) context[@"kCTFontFeatureSampleTextKey"] = [JSValue valueWithObject: (__bridge id) kCTFontFeatureSampleTextKey inContext: context];
	...
	p = (void*) &kCTFontFeatureTooltipTextKey;
	if (p != NULL) context[@"kCTFontFeatureTooltipTextKey"] = [JSValue valueWithObject: (__bridge id) kCTFontFeatureTooltipTextKey inContext: context];
}
