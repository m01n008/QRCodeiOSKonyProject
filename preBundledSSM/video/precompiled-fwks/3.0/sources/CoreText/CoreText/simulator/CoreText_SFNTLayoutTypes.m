...
-(JustWidthDeltaEntry) toJustWidthDeltaEntry {
	return (JustWidthDeltaEntry) {
		(UInt32) [self[@"justClass"] toUInt32],
		(Fixed) [self[@"beforeGrowLimit"] toInt32],
		(Fixed) [self[@"beforeShrinkLimit"] toInt32],
		(Fixed) [self[@"afterGrowLimit"] toInt32],
		(Fixed) [self[@"afterShrinkLimit"] toInt32],
...
-(STXHeader) toSTXHeader {
	return (STXHeader) {
		(UInt32) [self[@"nClasses"] toUInt32],
		(UInt32) [self[@"classTableOffset"] toUInt32],
		(UInt32) [self[@"stateArrayOffset"] toUInt32],
		(UInt32) [self[@"entryTableOffset"] toUInt32],
	};
}
...
-(JustPCDuctilityAction) toJustPCDuctilityAction {
	return (JustPCDuctilityAction) {
		(UInt32) [self[@"ductilityAxis"] toUInt32],
		(Fixed) [self[@"minimumLimit"] toInt32],
		(Fixed) [self[@"noStretchValue"] toInt32],
		(Fixed) [self[@"maximumLimit"] toInt32],
	};
}
...
-(JustPCConditionalAddAction) toJustPCConditionalAddAction {
	return (JustPCConditionalAddAction) {
		(Fixed) [self[@"substThreshold"] toInt32],
...
-(MorxLigatureSubtable) toMorxLigatureSubtable {
	return (MorxLigatureSubtable) {
		[self[@"header"] toSTXHeader],
		(UInt32) [self[@"ligatureActionTableOffset"] toUInt32],
		(UInt32) [self[@"componentTableOffset"] toUInt32],
		(UInt32) [self[@"ligatureTableOffset"] toUInt32],
	};
}
...
-(AnkrTable) toAnkrTable {
	return (AnkrTable) {
		...
		(UInt16) [self[@"flags"] toUInt32],
		(UInt32) [self[@"lookupTableOffset"] toUInt32],
		(UInt32) [self[@"anchorPointTableOffset"] toUInt32],
	};
}
...
-(MortFeatureEntry) toMortFeatureEntry {
	return (MortFeatureEntry) {
		...
		(MortSubtableMaskFlags) [self[@"enableFlags"] toUInt32],
		(MortSubtableMaskFlags) [self[@"disableFlags"] toUInt32],
	};
}
...
-(MorxContextualSubtable) toMorxContextualSubtable {
	return (MorxContextualSubtable) {
		[self[@"header"] toSTXHeader],
		(UInt32) [self[@"substitutionTableOffset"] toUInt32],
	};
}
...
-(JustPCActionSubrecord) toJustPCActionSubrecord {
	return (JustPCActionSubrecord) {
		...
		(UInt32) [self[@"length"] toUInt32],
		(UInt32) [self[@"data"] toUInt32],
	};
}
...
-(MorxInsertionSubtable) toMorxInsertionSubtable {
	return (MorxInsertionSubtable) {
		[self[@"header"] toSTXHeader],
		(UInt32) [self[@"insertionGlyphTableOffset"] toUInt32],
	};
}
...
-(KerxIndexArrayHeader) toKerxIndexArrayHeader {
	return (KerxIndexArrayHeader) {
		...
		(UInt32) [self[@"rowIndexTableOffset"] toUInt32],
		(UInt32) [self[@"columnIndexTableOffset"] toUInt32],
		(UInt32) [self[@"kerningArrayOffset"] toUInt32],
		(UInt32) [self[@"kerningVectorOffset"] toUInt32],
	};
}
@end
