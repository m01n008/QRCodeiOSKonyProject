...
@end
@protocol AVMutableVideoCompositionAVMutableVideoCompositionColorimeteryCategoryInstanceExports<JSExport>
@property (copy,nonatomic) NSString * colorYCbCrMatrix;
@property (copy,nonatomic) NSString * colorPrimaries;
@property (copy,nonatomic) NSString * colorTransferFunction;
@end
@protocol AVMutableVideoCompositionAVMutableVideoCompositionColorimeteryCategoryClassExports<JSExport>
@end
...
@end
@protocol AVVideoCompositionAVVideoCompositionColorimeteryCategoryInstanceExports<JSExport>
...
@end
@protocol AVVideoCompositionAVVideoCompositionColorimeteryCategoryClassExports<JSExport>
@end
...
@property (readonly,nonatomic) CMPersistentTrackID sourceTrackIDForFrameTiming;
