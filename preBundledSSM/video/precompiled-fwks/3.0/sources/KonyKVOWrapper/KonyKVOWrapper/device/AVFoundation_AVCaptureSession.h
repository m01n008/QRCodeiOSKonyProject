...
@protocol AVCaptureMultiCamSessionInstanceExports<JSExport>
@property (readonly,nonatomic) float hardwareCost;
@property (readonly,nonatomic) float systemPressureCost;
@end
@protocol AVCaptureMultiCamSessionClassExports<JSExport>
...
@property (copy,nonatomic) AVCaptureSessionPreset sessionPreset;
...
@property (getter=isCameraIntrinsicMatrixDeliverySupported,readonly,nonatomic) BOOL cameraIntrinsicMatrixDeliverySupported;
