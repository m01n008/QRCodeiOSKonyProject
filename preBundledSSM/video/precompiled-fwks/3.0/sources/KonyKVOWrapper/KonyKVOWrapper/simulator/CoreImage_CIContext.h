...
@protocol CIContextCIDepthBlurEffectCategoryInstanceExports<JSExport>
...
@end
@protocol CIContextCIDepthBlurEffectCategoryClassExports<JSExport>
@end
...
@end
@protocol CIContextcreateCGImageCategoryInstanceExports<JSExport>
...
@end
@protocol CIContextcreateCGImageCategoryClassExports<JSExport>
@end
