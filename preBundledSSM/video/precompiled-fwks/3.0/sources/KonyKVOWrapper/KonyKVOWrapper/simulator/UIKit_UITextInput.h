...
@end
@protocol UITextPlaceholderInstanceExports<JSExport>
@property (readonly,nonatomic) NSArray * rects;
@end
@protocol UITextPlaceholderClassExports<JSExport>
@end
...
-(void) insertText: (NSString *) text alternatives: (NSArray *) alternatives style: (UITextAlternativeStyle) style ;
@end
