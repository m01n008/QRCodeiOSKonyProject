...
JSExportAs(respondByRequestingPersistableContentKeyRequestAndReturnError,
...
JSExportAs(invalidatePersistableContentKeyOptionsCompletionHandler,
...
-(void) expire;
JSExportAs(invalidateAllPersistableContentKeysForAppOptionsCompletionHandler,
...
+(id) contentKeyResponseWithAuthorizationTokenData: (NSData *) authorizationTokenData ;
