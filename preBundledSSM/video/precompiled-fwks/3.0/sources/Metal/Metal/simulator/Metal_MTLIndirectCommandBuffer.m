...
{
	context[@"MTLIndirectCommandTypeDraw"] = @1UL;
	context[@"MTLIndirectCommandTypeDrawIndexed"] = @2UL;
	context[@"MTLIndirectCommandTypeDrawPatches"] = @4UL;
	context[@"MTLIndirectCommandTypeDrawIndexedPatches"] = @8UL;
	context[@"MTLIndirectCommandTypeConcurrentDispatch"] = @32UL;
	context[@"MTLIndirectCommandTypeConcurrentDispatchThreads"] = @64UL;
