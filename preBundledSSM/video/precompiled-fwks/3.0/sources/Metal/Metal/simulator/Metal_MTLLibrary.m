...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"MTLFunctionTypeVisible"] = @5UL;
	context[@"MTLFunctionTypeIntersection"] = @6UL;
	...
	context[@"MTLLanguageVersion2_1"] = @131073UL;
	context[@"MTLLanguageVersion2_2"] = @131074UL;
	context[@"MTLLanguageVersion2_3"] = @131075UL;

	context[@"MTLLibraryTypeExecutable"] = @0L;
	context[@"MTLLibraryTypeDynamic"] = @1L;
