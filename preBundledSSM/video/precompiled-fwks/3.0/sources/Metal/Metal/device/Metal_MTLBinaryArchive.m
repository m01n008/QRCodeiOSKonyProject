...
{
	context[@"MTLBinaryArchiveErrorNone"] = @0U;
	context[@"MTLBinaryArchiveErrorInvalidFile"] = @1U;
	context[@"MTLBinaryArchiveErrorUnexpectedElement"] = @2U;
	context[@"MTLBinaryArchiveErrorCompilationFailure"] = @3U;
