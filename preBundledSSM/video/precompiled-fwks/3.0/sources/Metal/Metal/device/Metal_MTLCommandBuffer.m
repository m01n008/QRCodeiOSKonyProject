...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"MTLCommandBufferErrorOptionNone"] = @0U;
	context[@"MTLCommandBufferErrorOptionEncoderExecutionStatus"] = @1U;

	context[@"MTLCommandEncoderErrorStateUnknown"] = @0;
	context[@"MTLCommandEncoderErrorStateCompleted"] = @1;
	context[@"MTLCommandEncoderErrorStateAffected"] = @2;
	context[@"MTLCommandEncoderErrorStatePending"] = @3;
	context[@"MTLCommandEncoderErrorStateFaulted"] = @4;

	context[@"MTLDispatchTypeSerial"] = @0U;
	context[@"MTLDispatchTypeConcurrent"] = @1U;
