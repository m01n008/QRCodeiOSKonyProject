...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"MTLFunctionTypeVisible"] = @5U;
	context[@"MTLFunctionTypeIntersection"] = @6U;
	...
	context[@"MTLLanguageVersion2_1"] = @131073U;
	context[@"MTLLanguageVersion2_2"] = @131074U;
	context[@"MTLLanguageVersion2_3"] = @131075U;

	context[@"MTLLibraryTypeExecutable"] = @0;
	context[@"MTLLibraryTypeDynamic"] = @1;
