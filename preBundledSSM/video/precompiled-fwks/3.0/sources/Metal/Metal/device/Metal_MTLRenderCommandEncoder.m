...
+(JSValue*) valueWithMTLVertexAmplificationViewMapping: (MTLVertexAmplificationViewMapping) s inContext: (JSContext*) context {
	return [JSValue valueWithObject: @{
		@"viewportArrayIndexOffset": @(s.viewportArrayIndexOffset),
		@"renderTargetArrayIndexOffset": @(s.renderTargetArrayIndexOffset),
	} inContext: context];
}
-(MTLVertexAmplificationViewMapping) toMTLVertexAmplificationViewMapping {
	return (MTLVertexAmplificationViewMapping) {
		(uint32_t) [self[@"viewportArrayIndexOffset"] toUInt32],
		(uint32_t) [self[@"renderTargetArrayIndexOffset"] toUInt32],
	};
}
