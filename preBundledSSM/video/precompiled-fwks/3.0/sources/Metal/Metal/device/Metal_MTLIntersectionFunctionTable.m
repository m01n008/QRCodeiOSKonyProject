...
{
	context[@"MTLIntersectionFunctionSignatureNone"] = @0U;
	context[@"MTLIntersectionFunctionSignatureInstancing"] = @1U;
	context[@"MTLIntersectionFunctionSignatureTriangleData"] = @2U;
	context[@"MTLIntersectionFunctionSignatureWorldSpaceData"] = @4U;
