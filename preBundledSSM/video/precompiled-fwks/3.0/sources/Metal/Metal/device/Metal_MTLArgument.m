...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"MTLDataTypeRenderPipeline"] = @78U;
	context[@"MTLDataTypeComputePipeline"] = @79U;
	context[@"MTLDataTypeIndirectCommandBuffer"] = @80U;
	context[@"MTLDataTypeVisibleFunctionTable"] = @115U;
	context[@"MTLDataTypeIntersectionFunctionTable"] = @116U;
	context[@"MTLDataTypePrimitiveAccelerationStructure"] = @117U;
	context[@"MTLDataTypeInstanceAccelerationStructure"] = @118U;
	...
	context[@"MTLArgumentTypeVisibleFunctionTable"] = @24U;
	context[@"MTLArgumentTypePrimitiveAccelerationStructure"] = @25U;
	context[@"MTLArgumentTypeInstanceAccelerationStructure"] = @26U;
	context[@"MTLArgumentTypeIntersectionFunctionTable"] = @27U;
