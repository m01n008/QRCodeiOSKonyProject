...
+(JSValue*) valueWithAudioPacketDependencyInfoTranslation: (AudioPacketDependencyInfoTranslation) s inContext: (JSContext*) context {
	return [JSValue valueWithObject: @{
		@"mPacket": @(s.mPacket),
		@"mIsIndependentlyDecodable": @(s.mIsIndependentlyDecodable),
		@"mNumberPrerollPackets": @(s.mNumberPrerollPackets),
	} inContext: context];
}
-(AudioPacketDependencyInfoTranslation) toAudioPacketDependencyInfoTranslation {
	return (AudioPacketDependencyInfoTranslation) {
		(SInt64) [self[@"mPacket"] toDouble],
		(UInt32) [self[@"mIsIndependentlyDecodable"] toDouble],
		(UInt32) [self[@"mNumberPrerollPackets"] toDouble],
	};
}
...
+(JSValue*) valueWithAudioPacketRangeByteCountTranslation: (AudioPacketRangeByteCountTranslation) s inContext: (JSContext*) context {
	return [JSValue valueWithObject: @{
		@"mPacket": @(s.mPacket),
		@"mPacketCount": @(s.mPacketCount),
		@"mByteCountUpperBound": @(s.mByteCountUpperBound),
	} inContext: context];
}
-(AudioPacketRangeByteCountTranslation) toAudioPacketRangeByteCountTranslation {
	return (AudioPacketRangeByteCountTranslation) {
		(SInt64) [self[@"mPacket"] toDouble],
		(SInt64) [self[@"mPacketCount"] toDouble],
		(SInt64) [self[@"mByteCountUpperBound"] toDouble],
	};
}
+(JSValue*) valueWithAudioPacketRollDistanceTranslation: (AudioPacketRollDistanceTranslation) s inContext: (JSContext*) context {
	return [JSValue valueWithObject: @{
		@"mPacket": @(s.mPacket),
		@"mRollDistance": @(s.mRollDistance),
	} inContext: context];
}
-(AudioPacketRollDistanceTranslation) toAudioPacketRollDistanceTranslation {
	return (AudioPacketRollDistanceTranslation) {
		(SInt64) [self[@"mPacket"] toDouble],
		(SInt64) [self[@"mRollDistance"] toDouble],
	};
}
...
+(JSValue*) valueWithAudioIndependentPacketTranslation: (AudioIndependentPacketTranslation) s inContext: (JSContext*) context {
	return [JSValue valueWithObject: @{
		@"mPacket": @(s.mPacket),
		@"mIndependentlyDecodablePacket": @(s.mIndependentlyDecodablePacket),
	} inContext: context];
}
-(AudioIndependentPacketTranslation) toAudioIndependentPacketTranslation {
	return (AudioIndependentPacketTranslation) {
		(SInt64) [self[@"mPacket"] toDouble],
		(SInt64) [self[@"mIndependentlyDecodablePacket"] toDouble],
	};
}
...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"kAudioFileRF64Type"] = @1380333108UL;
	context[@"kAudioFileBW64Type"] = @1113011764UL;
	context[@"kAudioFileWave64Type"] = @1463170150UL;
	...
	context[@"kAudioFileFLACType"] = @1718378851UL;
	context[@"kAudioFileLATMInLOASType"] = @1819238771UL;
	...
	context[@"kAudioFileInvalidPacketDependencyError"] = @1684369471L;
	...
	context[@"kAudioFilePropertyRestrictsRandomAccess"] = @1920098672UL;
	context[@"kAudioFilePropertyPacketToRollDistance"] = @1886089836UL;
	context[@"kAudioFilePropertyPreviousIndependentPacket"] = @1885957732UL;
	context[@"kAudioFilePropertyNextIndependentPacket"] = @1852403300UL;
	context[@"kAudioFilePropertyPacketToDependencyInfo"] = @1886086256UL;
	...
	context[@"kAudioFilePropertyPacketRangeByteCountUpperBound"] = @1886549346UL;
	...
	context[@"kAudioFilePropertyID3TagOffset"] = @1768174447UL;
