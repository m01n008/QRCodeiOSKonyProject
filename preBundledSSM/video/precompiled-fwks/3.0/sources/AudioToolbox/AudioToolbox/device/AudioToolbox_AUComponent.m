...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"kAudioUnitErr_MIDIOutputBufferFull"] = @-66753L;
	context[@"kAudioComponentErr_InstanceTimedOut"] = @-66754L;
	context[@"kAudioComponentErr_InstanceInvalidated"] = @-66749L;
	context[@"kAudioUnitErr_RenderTimeout"] = @-66745L;
	context[@"kAudioUnitErr_ExtensionNotFound"] = @-66744L;
	context[@"kAudioUnitErr_InvalidParameterValue"] = @-66743L;
	context[@"kAudioUnitErr_InvalidFilePath"] = @-66742L;
	context[@"kAudioUnitErr_MissingKey"] = @-66741L;
