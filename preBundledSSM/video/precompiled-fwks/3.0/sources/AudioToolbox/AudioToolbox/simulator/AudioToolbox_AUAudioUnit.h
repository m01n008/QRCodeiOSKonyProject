...
@property (getter=getJsProfileChangedBlock,setter=setJsProfileChangedBlock:) JSValue* jsprofileChangedBlock;
...
JSExportAs(disableProfileCableOnChannelError,
