...
-(AudioUnitNodeConnection) toAudioUnitNodeConnection {
	return (AudioUnitNodeConnection) {
		(AUNode) [self[@"sourceNode"] toInt32],
		(UInt32) [self[@"sourceOutputNumber"] toUInt32],
		(AUNode) [self[@"destNode"] toInt32],
		(UInt32) [self[@"destInputNumber"] toUInt32],
	};
}
@end
...
{
	context[@"kAUGraphErr_NodeNotFound"] = @-10860;
	context[@"kAUGraphErr_InvalidConnection"] = @-10861;
	context[@"kAUGraphErr_OutputNodeErr"] = @-10862;
	context[@"kAUGraphErr_CannotDoInCurrentContext"] = @-10863;
	context[@"kAUGraphErr_InvalidAudioUnit"] = @-10864;

	context[@"kAUNodeInteraction_Connection"] = @1U;
	context[@"kAUNodeInteraction_InputCallback"] = @2U;
