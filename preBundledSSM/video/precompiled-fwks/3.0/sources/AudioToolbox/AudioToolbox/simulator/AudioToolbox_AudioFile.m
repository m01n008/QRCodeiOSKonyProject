...
-(AudioPacketDependencyInfoTranslation) toAudioPacketDependencyInfoTranslation {
	return (AudioPacketDependencyInfoTranslation) {
		...
		(UInt32) [self[@"mIsIndependentlyDecodable"] toUInt32],
		(UInt32) [self[@"mNumberPrerollPackets"] toUInt32],
	};
}
...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"kAudioFileBW64Type"] = @1113011764U;
	context[@"kAudioFileWave64Type"] = @1463170150U;
	...
	context[@"kAudioFileLATMInLOASType"] = @1819238771U;
	...
	context[@"kAudioFileInvalidPacketDependencyError"] = @1684369471;
	...
	context[@"kAudioFilePropertyRestrictsRandomAccess"] = @1920098672U;
	context[@"kAudioFilePropertyPacketToRollDistance"] = @1886089836U;
	context[@"kAudioFilePropertyPreviousIndependentPacket"] = @1885957732U;
	context[@"kAudioFilePropertyNextIndependentPacket"] = @1852403300U;
	context[@"kAudioFilePropertyPacketToDependencyInfo"] = @1886086256U;
	...
	context[@"kAudioFilePropertyPacketRangeByteCountUpperBound"] = @1886549346U;
	...
	context[@"kAudioFilePropertyID3TagOffset"] = @1768174447U;
