...
{
	context[@"AudioSessionSetActiveWithFlags"] = ^OSStatus(Boolean arg0, UInt32 arg1) {
		return AudioSessionSetActiveWithFlags(arg0, arg1);
	};
	context[@"AudioSessionSetActive"] = ^OSStatus(Boolean arg0) {
		return AudioSessionSetActive(arg0);
	};
	context[@"AudioSessionRemovePropertyListener"] = ^OSStatus(AudioSessionPropertyID arg0) {
		return AudioSessionRemovePropertyListener(arg0);
	};
}
