...
-(JSValue *) getJsRenderContextObserver
{
	return [JSValue valueWithObject: self.renderContextObserver inContext: [JSContext currentContext]];
}
@end
...
void AudioToolbox_AUAudioUnitImplementationProtocols()
{
	(void)@protocol(AUAudioUnitFactory);
}
void load_AudioToolbox_AUAudioUnitImplementation_symbols(JSContext* context)
{
    addProtocols();
