...
{
	context[@"NSOrderedCollectionDifferenceCalculationOmitInsertedObjects"] = @1UL;
	context[@"NSOrderedCollectionDifferenceCalculationOmitRemovedObjects"] = @2UL;
	context[@"NSOrderedCollectionDifferenceCalculationInferMoves"] = @4UL;
