...
@end
@implementation NSOrderedSet (NSOrderedSetNSOrderedSetDiffingCategoryExports)
...
{
	BOOL (^ block_)(id , id ) = nil;
	if (!block.isUndefined) {
		block_ = ^BOOL(id arg0, id arg1) {
	...
	resultVal__ = [self differenceFromOrderedSet: other withOptions: options usingEquivalenceTest: block_ ];
	return resultVal__;
}
@end
...
static void addProtocols()
{
	...
	class_addProtocol([NSMutableOrderedSet class], @protocol(NSMutableOrderedSetNSMutableOrderedSetDiffingCategoryInstanceExports));
	class_addProtocol([NSMutableOrderedSet class], @protocol(NSMutableOrderedSetNSMutableOrderedSetDiffingCategoryClassExports));
	...
	class_addProtocol([NSOrderedSet class], @protocol(NSOrderedSetNSOrderedSetDiffingCategoryInstanceExports));
	class_addProtocol([NSOrderedSet class], @protocol(NSOrderedSetNSOrderedSetDiffingCategoryClassExports));
