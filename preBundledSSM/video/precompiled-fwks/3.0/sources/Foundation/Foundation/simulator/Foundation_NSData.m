...
@end
@implementation NSMutableData (NSMutableDataNSMutableDataCompressionCategoryExports)
-(BOOL) jscompressUsingAlgorithm: (NSDataCompressionAlgorithm) algorithm error: (JSValue *) error 
{
	NSError* error_ = nil;
	BOOL resultVal__;
	resultVal__ = [self compressUsingAlgorithm: algorithm error: &error_ ];
...
-(BOOL) jsdecompressUsingAlgorithm: (NSDataCompressionAlgorithm) algorithm error: (JSValue *) error 
{
	NSError* error_ = nil;
	BOOL resultVal__;
	resultVal__ = [self decompressUsingAlgorithm: algorithm error: &error_ ];
	if (error_ && [error isObject]) {
		error[@"error"] = error_;
	}
	return resultVal__;
...
@end
@implementation NSData (NSDataNSDataCompressionCategoryExports)
-(id) jsdecompressedDataUsingAlgorithm: (NSDataCompressionAlgorithm) algorithm error: (JSValue *) error 
{
	NSError* error_ = nil;
	id resultVal__;
	resultVal__ = [self decompressedDataUsingAlgorithm: algorithm error: &error_ ];
	if (error_ && [error isObject]) {
		error[@"error"] = error_;
	}
	return resultVal__;
...
-(id) jscompressedDataUsingAlgorithm: (NSDataCompressionAlgorithm) algorithm error: (JSValue *) error 
{
	NSError* error_ = nil;
	id resultVal__;
	resultVal__ = [self compressedDataUsingAlgorithm: algorithm error: &error_ ];
	if (error_ && [error isObject]) {
		error[@"error"] = error_;
	}
	return resultVal__;
...
static void addProtocols()
{
	...
	class_addProtocol([NSMutableData class], @protocol(NSMutableDataNSMutableDataCompressionCategoryInstanceExports));
	class_addProtocol([NSMutableData class], @protocol(NSMutableDataNSMutableDataCompressionCategoryClassExports));
	...
	class_addProtocol([NSData class], @protocol(NSDataNSDataCompressionCategoryInstanceExports));
	class_addProtocol([NSData class], @protocol(NSDataNSDataCompressionCategoryClassExports));
...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSDataCompressionAlgorithmLZFSE"] = @0L;
	context[@"NSDataCompressionAlgorithmLZ4"] = @1L;
	context[@"NSDataCompressionAlgorithmLZMA"] = @2L;
	context[@"NSDataCompressionAlgorithmZlib"] = @3L;
