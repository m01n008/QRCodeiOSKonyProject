...
void loadNFIFoundationModules(JSContext* context)
{
	...
	load_Foundation_NSRelativeDateTimeFormatter_symbols(context);
	...
	load_Foundation_NSListFormatter_symbols(context);
	load_Foundation_NSMapTable_symbols(context);
	load_Foundation_NSOrderedCollectionDifference_symbols(context);
	...
	load_Foundation_NSOrderedCollectionChange_symbols(context);
