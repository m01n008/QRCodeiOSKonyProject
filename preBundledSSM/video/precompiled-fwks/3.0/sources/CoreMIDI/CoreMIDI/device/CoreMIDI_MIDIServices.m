...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"kMIDIUnknownError"] = @-10845L;
	...
	context[@"kMIDIProtocol_1_0"] = @1L;
	context[@"kMIDIProtocol_2_0"] = @2L;
...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &kMIDIPropertyNameConfigurationDictionary;
	if (p != NULL) context[@"kMIDIPropertyNameConfigurationDictionary"] = [JSValue valueWithObject: (__bridge id) kMIDIPropertyNameConfigurationDictionary inContext: context];
	...
	p = (void*) &kMIDIPropertyProtocolID;
	if (p != NULL) context[@"kMIDIPropertyProtocolID"] = [JSValue valueWithObject: (__bridge id) kMIDIPropertyProtocolID inContext: context];
