{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFICoreGraphics',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls CoreGraphics/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'CoreGraphics/simulator/NFICoreGraphicsLoader.h',
                        'CoreGraphics/simulator/NFICoreGraphics.h',
                    ],
                    'xcode_settings': {
                        'ENABLE_BITCODE': 'NO',
                        'INFOPLIST_FILE': 'CoreGraphics/Info.plist',
                        'OTHER_LDFLAGS': [
