...
{
	context[@"kCMFormatDescriptionBridgeError_InvalidParameter"] = @-12712L;
	context[@"kCMFormatDescriptionBridgeError_AllocationFailed"] = @-12713L;
	context[@"kCMFormatDescriptionBridgeError_InvalidSerializedSampleDescription"] = @-12714L;
	context[@"kCMFormatDescriptionBridgeError_InvalidFormatDescription"] = @-12715L;
	context[@"kCMFormatDescriptionBridgeError_IncompatibleFormatDescription"] = @-12716L;
	context[@"kCMFormatDescriptionBridgeError_UnsupportedSampleDescriptionFlavor"] = @-12717L;
	context[@"kCMFormatDescriptionBridgeError_InvalidSlice"] = @-12719L;
