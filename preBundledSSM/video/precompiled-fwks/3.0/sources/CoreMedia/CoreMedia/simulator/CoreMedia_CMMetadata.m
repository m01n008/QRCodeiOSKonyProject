...
{
	context[@"kCMMetadataIdentifierError_AllocationFailed"] = @-16300;
	context[@"kCMMetadataIdentifierError_RequiredParameterMissing"] = @-16301;
	context[@"kCMMetadataIdentifierError_BadKey"] = @-16302;
	context[@"kCMMetadataIdentifierError_BadKeyLength"] = @-16303;
	context[@"kCMMetadataIdentifierError_BadKeyType"] = @-16304;
	context[@"kCMMetadataIdentifierError_BadNumberKey"] = @-16305;
	context[@"kCMMetadataIdentifierError_BadKeySpace"] = @-16306;
	context[@"kCMMetadataIdentifierError_BadIdentifier"] = @-16307;
	context[@"kCMMetadataIdentifierError_NoKeyValueAvailable"] = @-16308;

	context[@"kCMMetadataDataTypeRegistryError_AllocationFailed"] = @-16310;
	context[@"kCMMetadataDataTypeRegistryError_RequiredParameterMissing"] = @-16311;
	context[@"kCMMetadataDataTypeRegistryError_BadDataTypeIdentifier"] = @-16312;
	context[@"kCMMetadataDataTypeRegistryError_DataTypeAlreadyRegistered"] = @-16313;
	context[@"kCMMetadataDataTypeRegistryError_RequiresConformingBaseType"] = @-16314;
	context[@"kCMMetadataDataTypeRegistryError_MultipleConformingBaseTypes"] = @-16315;
...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &kCMMetadataBaseDataType_PerspectiveTransformF64;
	if (p != NULL) context[@"kCMMetadataBaseDataType_PerspectiveTransformF64"] = [JSValue valueWithObject: (__bridge id) kCMMetadataBaseDataType_PerspectiveTransformF64 inContext: context];
	...
	p = (void*) &kCMMetadataIdentifier_QuickTimeMetadataLivePhotoStillImageTransformReferenceDimensions;
	if (p != NULL) context[@"kCMMetadataIdentifier_QuickTimeMetadataLivePhotoStillImageTransformReferenceDimensions"] = [JSValue valueWithObject: (__bridge id) kCMMetadataIdentifier_QuickTimeMetadataLivePhotoStillImageTransformReferenceDimensions inContext: context];
	...
	p = (void*) &kCMMetadataIdentifier_QuickTimeMetadataLivePhotoStillImageTransform;
	if (p != NULL) context[@"kCMMetadataIdentifier_QuickTimeMetadataLivePhotoStillImageTransform"] = [JSValue valueWithObject: (__bridge id) kCMMetadataIdentifier_QuickTimeMetadataLivePhotoStillImageTransform inContext: context];
