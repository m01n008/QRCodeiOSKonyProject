...
static void registerCFunctions(JSContext* context)
{
	...
	context[@"CMTimebaseSetMasterClock"] = ^OSStatus(id arg0, id arg1) {
		return CMTimebaseSetMasterClock(arg0, arg1);
	};
	...
	context[@"CMTimebaseSetMasterTimebase"] = ^OSStatus(id arg0, id arg1) {
		return CMTimebaseSetMasterTimebase(arg0, arg1);
	};
}
