...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &kCGImageDestinationPreserveGainMap;
	if (p != NULL) context[@"kCGImageDestinationPreserveGainMap"] = [JSValue valueWithObject: (__bridge id) kCGImageDestinationPreserveGainMap inContext: context];
