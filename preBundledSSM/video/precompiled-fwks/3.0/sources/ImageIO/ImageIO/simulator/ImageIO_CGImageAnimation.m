...
{
	context[@"kCGImageAnimationStatus_ParameterError"] = @-22140;
	context[@"kCGImageAnimationStatus_CorruptInputImage"] = @-22141;
	context[@"kCGImageAnimationStatus_UnsupportedFormat"] = @-22142;
	context[@"kCGImageAnimationStatus_IncompleteInputImage"] = @-22143;
	context[@"kCGImageAnimationStatus_AllocationFailure"] = @-22144;
