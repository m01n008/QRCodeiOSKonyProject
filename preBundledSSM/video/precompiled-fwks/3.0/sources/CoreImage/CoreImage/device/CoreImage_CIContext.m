...
{
	class_addProtocol([CIContext class], @protocol(CIContextCIDepthBlurEffectCategoryInstanceExports));
	class_addProtocol([CIContext class], @protocol(CIContextCIDepthBlurEffectCategoryClassExports));
	...
	class_addProtocol([CIContext class], @protocol(CIContextcreateCGImageCategoryInstanceExports));
	class_addProtocol([CIContext class], @protocol(CIContextcreateCGImageCategoryClassExports));
...
{
	void* p; p = NULL;
	p = (void*) &kCIImageRepresentationSemanticSegmentationHairMatteImage;
	if (p != NULL) context[@"kCIImageRepresentationSemanticSegmentationHairMatteImage"] = kCIImageRepresentationSemanticSegmentationHairMatteImage;
	...
	p = (void*) &kCIContextAllowLowPower;
	if (p != NULL) context[@"kCIContextAllowLowPower"] = kCIContextAllowLowPower;
	p = (void*) &kCIContextOutputPremultiplied;
	if (p != NULL) context[@"kCIContextOutputPremultiplied"] = kCIContextOutputPremultiplied;
	p = (void*) &kCIImageRepresentationSemanticSegmentationSkyMatteImage;
	if (p != NULL) context[@"kCIImageRepresentationSemanticSegmentationSkyMatteImage"] = kCIImageRepresentationSemanticSegmentationSkyMatteImage;
	p = (void*) &kCIImageRepresentationSemanticSegmentationSkinMatteImage;
	if (p != NULL) context[@"kCIImageRepresentationSemanticSegmentationSkinMatteImage"] = kCIImageRepresentationSemanticSegmentationSkinMatteImage;
	p = (void*) &kCIImageRepresentationPortraitEffectsMatteImage;
	if (p != NULL) context[@"kCIImageRepresentationPortraitEffectsMatteImage"] = kCIImageRepresentationPortraitEffectsMatteImage;
	...
	p = (void*) &kCIImageRepresentationAVPortraitEffectsMatte;
	if (p != NULL) context[@"kCIImageRepresentationAVPortraitEffectsMatte"] = kCIImageRepresentationAVPortraitEffectsMatte;
	...
	p = (void*) &kCIContextName;
	if (p != NULL) context[@"kCIContextName"] = kCIContextName;
	...
	p = (void*) &kCIImageRepresentationAVSemanticSegmentationMattes;
	if (p != NULL) context[@"kCIImageRepresentationAVSemanticSegmentationMattes"] = kCIImageRepresentationAVSemanticSegmentationMattes;
	p = (void*) &kCIContextCacheIntermediates;
	if (p != NULL) context[@"kCIContextCacheIntermediates"] = kCIContextCacheIntermediates;
	p = (void*) &kCIImageRepresentationSemanticSegmentationGlassesMatteImage;
	if (p != NULL) context[@"kCIImageRepresentationSemanticSegmentationGlassesMatteImage"] = kCIImageRepresentationSemanticSegmentationGlassesMatteImage;
	p = (void*) &kCIImageRepresentationSemanticSegmentationTeethMatteImage;
	if (p != NULL) context[@"kCIImageRepresentationSemanticSegmentationTeethMatteImage"] = kCIImageRepresentationSemanticSegmentationTeethMatteImage;
}
