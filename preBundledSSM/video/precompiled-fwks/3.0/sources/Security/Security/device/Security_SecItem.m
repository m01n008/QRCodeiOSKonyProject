...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &kSecUseDataProtectionKeychain;
	if (p != NULL) context[@"kSecUseDataProtectionKeychain"] = [JSValue valueWithObject: (__bridge id) kSecUseDataProtectionKeychain inContext: context];
