...
@protocol NSTextAttachmentInstanceExports<JSExport, NSTextAttachmentContainerInstanceExports_, NSSecureCodingInstanceExports_>
...
@end
@protocol NSTextAttachmentClassExports<JSExport, NSTextAttachmentContainerClassExports_, NSSecureCodingClassExports_>
@end
