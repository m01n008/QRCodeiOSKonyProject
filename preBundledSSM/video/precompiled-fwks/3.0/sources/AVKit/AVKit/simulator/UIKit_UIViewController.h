...
@property (readonly,nonatomic) UIViewController * childViewControllerForScreenEdgesDeferringSystemGestures;
...
@end
@protocol UIViewControllerUIPointerLockSupportCategoryInstanceExports<JSExport>
@property (readonly,nonatomic) UIViewController * childViewControllerForPointerLock;
@property (readonly,nonatomic) BOOL prefersPointerLocked;
-(void) setNeedsUpdateOfPrefersPointerLocked;
@end
@protocol UIViewControllerUIPointerLockSupportCategoryClassExports<JSExport>
@end
...
@end
@protocol UIViewControllerUIPresentationControllerCategoryInstanceExports<JSExport>
...
@end
@protocol UIViewControllerUIPresentationControllerCategoryClassExports<JSExport>
@end
...
JSExportAs(canPerformUnwindSegueActionFromViewControllerSender,
...
@end
@protocol UIViewControllerUIPerformsActionsCategoryInstanceExports<JSExport>
@property (readonly,nonatomic) BOOL performsActionsWhilePresentingModally;
@end
@protocol UIViewControllerUIPerformsActionsCategoryClassExports<JSExport>
@end
