...
{
	context[@"UNNotificationActionOptionAuthenticationRequired"] = @1UL;
	context[@"UNNotificationActionOptionDestructive"] = @2UL;
	context[@"UNNotificationActionOptionForeground"] = @4UL;
