{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFIUserNotifications',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls UserNotifications/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'UserNotifications/simulator/NFIUserNotificationsLoader.h',
                        'UserNotifications/simulator/NFIUserNotifications.h',
                    ],
                    'xcode_settings': {
                        'ENABLE_BITCODE': 'NO',
                        'INFOPLIST_FILE': 'UserNotifications/Info.plist',
                        'OTHER_LDFLAGS': [
