...
{
	void* p; p = NULL;
	p = (void*) &AVSampleBufferRenderSynchronizerRateDidChangeNotification;
	if (p != NULL) context[@"AVSampleBufferRenderSynchronizerRateDidChangeNotification"] = AVSampleBufferRenderSynchronizerRateDidChangeNotification;
}
