...
{
	class_addProtocol([AVCaptureMultiCamSession class], @protocol(AVCaptureMultiCamSessionInstanceExports));
	class_addProtocol([AVCaptureMultiCamSession class], @protocol(AVCaptureMultiCamSessionClassExports));
