...
-(BOOL) jsrespondByRequestingPersistableContentKeyRequestAndReturnError: (JSValue *) outError 
{
	NSError* outError_ = nil;
	BOOL resultVal__;
	resultVal__ = [self respondByRequestingPersistableContentKeyRequestAndReturnError: &outError_ ];
...
-(void) jsinvalidateAllPersistableContentKeysForApp: (NSData *) appIdentifier options: (NSDictionary *) options completionHandler: (JSValue *) handler 
{
	void (^ handler_)(NSData * , NSError * ) = nil;
	if (!handler.isUndefined) {
		handler_ = ^void(NSData * arg0, NSError * arg1) {
	...
	[self invalidateAllPersistableContentKeysForApp: appIdentifier options: options completionHandler: handler_ ];
}
...
-(void) jsinvalidatePersistableContentKey: (NSData *) persistableContentKeyData options: (NSDictionary *) options completionHandler: (JSValue *) handler 
{
	void (^ handler_)(NSData * , NSError * ) = nil;
	if (!handler.isUndefined) {
		handler_ = ^void(NSData * arg0, NSError * arg1) {
	...
	[self invalidatePersistableContentKey: persistableContentKeyData options: options completionHandler: handler_ ];
}
@end
...
{
	context[@"AVContentKeyRequestStatusRequestingResponse"] = @0;
	context[@"AVContentKeyRequestStatusReceivedResponse"] = @1;
	context[@"AVContentKeyRequestStatusRenewed"] = @2;
	context[@"AVContentKeyRequestStatusRetried"] = @3;
	context[@"AVContentKeyRequestStatusCancelled"] = @4;
	context[@"AVContentKeyRequestStatusFailed"] = @5;

}
static void registerGlobalConstants(JSContext* context)
{
	void* p; p = NULL;
	p = (void*) &AVContentKeyRequestRequiresValidationDataInSecureTokenKey;
	if (p != NULL) context[@"AVContentKeyRequestRequiresValidationDataInSecureTokenKey"] = AVContentKeyRequestRequiresValidationDataInSecureTokenKey;
	p = (void*) &AVContentKeySessionServerPlaybackContextOptionServerChallenge;
	if (p != NULL) context[@"AVContentKeySessionServerPlaybackContextOptionServerChallenge"] = AVContentKeySessionServerPlaybackContextOptionServerChallenge;
	...
	p = (void*) &AVContentKeySystemAuthorizationToken;
	if (p != NULL) context[@"AVContentKeySystemAuthorizationToken"] = AVContentKeySystemAuthorizationToken;
	p = (void*) &AVContentKeySessionServerPlaybackContextOptionProtocolVersions;
	if (p != NULL) context[@"AVContentKeySessionServerPlaybackContextOptionProtocolVersions"] = AVContentKeySessionServerPlaybackContextOptionProtocolVersions;
