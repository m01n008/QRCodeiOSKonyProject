...
{
	context[@"AVAudioEnvironmentDistanceAttenuationModelExponential"] = @1;
	context[@"AVAudioEnvironmentDistanceAttenuationModelInverse"] = @2;
	context[@"AVAudioEnvironmentDistanceAttenuationModelLinear"] = @3;

	context[@"AVAudioEnvironmentOutputTypeAuto"] = @0;
	context[@"AVAudioEnvironmentOutputTypeHeadphones"] = @1;
	context[@"AVAudioEnvironmentOutputTypeBuiltInSpeakers"] = @2;
	context[@"AVAudioEnvironmentOutputTypeExternalSpeakers"] = @3;
