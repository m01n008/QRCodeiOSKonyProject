...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &AVOutputSettingsPresetHEVC1920x1080WithAlpha;
	if (p != NULL) context[@"AVOutputSettingsPresetHEVC1920x1080WithAlpha"] = AVOutputSettingsPresetHEVC1920x1080WithAlpha;
	...
	p = (void*) &AVOutputSettingsPresetHEVC3840x2160WithAlpha;
	if (p != NULL) context[@"AVOutputSettingsPresetHEVC3840x2160WithAlpha"] = AVOutputSettingsPresetHEVC3840x2160WithAlpha;
}
