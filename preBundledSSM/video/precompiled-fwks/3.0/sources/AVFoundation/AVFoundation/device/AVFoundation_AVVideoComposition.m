...
static void addProtocols()
{
	...
	class_addProtocol([AVMutableVideoComposition class], @protocol(AVMutableVideoCompositionAVMutableVideoCompositionColorimeteryCategoryInstanceExports));
	class_addProtocol([AVMutableVideoComposition class], @protocol(AVMutableVideoCompositionAVMutableVideoCompositionColorimeteryCategoryClassExports));
	...
	class_addProtocol([AVVideoComposition class], @protocol(AVVideoCompositionAVVideoCompositionColorimeteryCategoryInstanceExports));
	class_addProtocol([AVVideoComposition class], @protocol(AVVideoCompositionAVVideoCompositionColorimeteryCategoryClassExports));
