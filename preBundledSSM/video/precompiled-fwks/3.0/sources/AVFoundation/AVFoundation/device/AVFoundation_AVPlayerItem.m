...
{
	context[@"AVPlayerItemStatusUnknown"] = @0;
	context[@"AVPlayerItemStatusReadyToPlay"] = @1;
	context[@"AVPlayerItemStatusFailed"] = @2;

	context[@"AVAudioSpatializationFormatNone"] = @0U;
	context[@"AVAudioSpatializationFormatMonoAndStereo"] = @3U;
	context[@"AVAudioSpatializationFormatMultichannel"] = @4U;
	context[@"AVAudioSpatializationFormatMonoStereoAndMultichannel"] = @7U;

}
static void registerGlobalConstants(JSContext* context)
{
	void* p; p = NULL;
	p = (void*) &AVPlayerItemMediaSelectionDidChangeNotification;
	if (p != NULL) context[@"AVPlayerItemMediaSelectionDidChangeNotification"] = AVPlayerItemMediaSelectionDidChangeNotification;
	...
	p = (void*) &AVPlayerItemRecommendedTimeOffsetFromLiveDidChangeNotification;
	if (p != NULL) context[@"AVPlayerItemRecommendedTimeOffsetFromLiveDidChangeNotification"] = AVPlayerItemRecommendedTimeOffsetFromLiveDidChangeNotification;
