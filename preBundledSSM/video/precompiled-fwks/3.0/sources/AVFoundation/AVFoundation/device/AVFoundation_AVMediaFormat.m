...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &AVMediaCharacteristicContainsHDRVideo;
	if (p != NULL) context[@"AVMediaCharacteristicContainsHDRVideo"] = AVMediaCharacteristicContainsHDRVideo;
	...
	p = (void*) &AVMediaCharacteristicContainsAlphaChannel;
	if (p != NULL) context[@"AVMediaCharacteristicContainsAlphaChannel"] = AVMediaCharacteristicContainsAlphaChannel;
	...
	p = (void*) &AVFileTypeProfileMPEG4AppleHLS;
	if (p != NULL) context[@"AVFileTypeProfileMPEG4AppleHLS"] = AVFileTypeProfileMPEG4AppleHLS;
	...
	p = (void*) &AVFileTypeProfileMPEG4CMAFCompliant;
	if (p != NULL) context[@"AVFileTypeProfileMPEG4CMAFCompliant"] = AVFileTypeProfileMPEG4CMAFCompliant;
	...
	p = (void*) &AVMediaCharacteristicIsOriginalContent;
	if (p != NULL) context[@"AVMediaCharacteristicIsOriginalContent"] = AVMediaCharacteristicIsOriginalContent;
