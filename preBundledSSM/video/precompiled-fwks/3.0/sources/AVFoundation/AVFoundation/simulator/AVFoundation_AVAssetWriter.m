...
{
	id resultVal__;
	resultVal__ = [[self initWithContentType: outputContentType ] autorelease];
	return resultVal__;
}
...
static void addProtocols()
{
	...
	class_addProtocol([AVAssetWriter class], @protocol(AVAssetWriterAVAssetWriterSegmentationCategoryInstanceExports));
	class_addProtocol([AVAssetWriter class], @protocol(AVAssetWriterAVAssetWriterSegmentationCategoryClassExports));
}
...
{
	context[@"AVAssetWriterStatusUnknown"] = @0L;
	context[@"AVAssetWriterStatusWriting"] = @1L;
	context[@"AVAssetWriterStatusCompleted"] = @2L;
	context[@"AVAssetWriterStatusFailed"] = @3L;
	context[@"AVAssetWriterStatusCancelled"] = @4L;
...
void AVFoundation_AVAssetWriterProtocols()
{
	(void)@protocol(AVAssetWriterDelegate);
}
