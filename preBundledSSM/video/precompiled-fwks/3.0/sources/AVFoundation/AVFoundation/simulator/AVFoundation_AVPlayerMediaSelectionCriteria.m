...
{
	id resultVal__;
	resultVal__ = [[self initWithPrincipalMediaCharacteristics: principalMediaCharacteristics preferredLanguages: preferredLanguages preferredMediaCharacteristics: preferredMediaCharacteristics ] autorelease];
	return resultVal__;
}
