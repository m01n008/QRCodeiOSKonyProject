...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"AVAudio3DMixingRenderingAlgorithmAuto"] = @7L;

	context[@"AVAudio3DMixingSourceModeSpatializeIfMono"] = @0L;
	context[@"AVAudio3DMixingSourceModeBypass"] = @1L;
	context[@"AVAudio3DMixingSourceModePointSource"] = @2L;
	context[@"AVAudio3DMixingSourceModeAmbienceBed"] = @3L;

	context[@"AVAudio3DMixingPointSourceInHeadModeMono"] = @0L;
	context[@"AVAudio3DMixingPointSourceInHeadModeBypass"] = @1L;
