...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"AVAudioSpatializationFormatNone"] = @0UL;
	context[@"AVAudioSpatializationFormatMonoAndStereo"] = @3UL;
	context[@"AVAudioSpatializationFormatMultichannel"] = @4UL;
	context[@"AVAudioSpatializationFormatMonoStereoAndMultichannel"] = @7UL;
