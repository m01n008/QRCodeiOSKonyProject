...
{
	context[@"AVAssetExportSessionStatusUnknown"] = @0L;
	context[@"AVAssetExportSessionStatusWaiting"] = @1L;
	context[@"AVAssetExportSessionStatusExporting"] = @2L;
	context[@"AVAssetExportSessionStatusCompleted"] = @3L;
	context[@"AVAssetExportSessionStatusFailed"] = @4L;
	context[@"AVAssetExportSessionStatusCancelled"] = @5L;
