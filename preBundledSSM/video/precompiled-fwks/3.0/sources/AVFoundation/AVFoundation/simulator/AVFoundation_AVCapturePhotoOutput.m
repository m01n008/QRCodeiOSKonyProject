...
{
	context[@"AVCapturePhotoQualityPrioritizationSpeed"] = @1L;
	context[@"AVCapturePhotoQualityPrioritizationBalanced"] = @2L;
	context[@"AVCapturePhotoQualityPrioritizationQuality"] = @3L;

	context[@"AVCaptureLensStabilizationStatusUnsupported"] = @0L;
	context[@"AVCaptureLensStabilizationStatusOff"] = @1L;
	context[@"AVCaptureLensStabilizationStatusActive"] = @2L;
	context[@"AVCaptureLensStabilizationStatusOutOfRange"] = @3L;
	context[@"AVCaptureLensStabilizationStatusUnavailable"] = @4L;
