...
{
	context[@"AVAssetReferenceRestrictionForbidNone"] = @0UL;
	context[@"AVAssetReferenceRestrictionForbidRemoteReferenceToLocal"] = @1UL;
	context[@"AVAssetReferenceRestrictionForbidLocalReferenceToRemote"] = @2UL;
	context[@"AVAssetReferenceRestrictionForbidCrossSiteReference"] = @4UL;
	context[@"AVAssetReferenceRestrictionForbidLocalReferenceToLocal"] = @8UL;
	context[@"AVAssetReferenceRestrictionForbidAll"] = @65535UL;
	context[@"AVAssetReferenceRestrictionDefaultPolicy"] = @2UL;
