...
{
	context[@"AVPlayerLooperStatusUnknown"] = @0L;
	context[@"AVPlayerLooperStatusReady"] = @1L;
	context[@"AVPlayerLooperStatusFailed"] = @2L;
	context[@"AVPlayerLooperStatusCancelled"] = @3L;
