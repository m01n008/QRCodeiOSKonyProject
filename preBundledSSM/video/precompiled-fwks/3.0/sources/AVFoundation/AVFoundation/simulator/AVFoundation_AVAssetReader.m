...
{
	context[@"AVAssetReaderStatusUnknown"] = @0L;
	context[@"AVAssetReaderStatusReading"] = @1L;
	context[@"AVAssetReaderStatusCompleted"] = @2L;
	context[@"AVAssetReaderStatusFailed"] = @3L;
	context[@"AVAssetReaderStatusCancelled"] = @4L;
