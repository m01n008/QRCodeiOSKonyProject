...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &AVAudioUnitComponentManagerRegistrationsChangedNotification;
	if (p != NULL) context[@"AVAudioUnitComponentManagerRegistrationsChangedNotification"] = AVAudioUnitComponentManagerRegistrationsChangedNotification;
