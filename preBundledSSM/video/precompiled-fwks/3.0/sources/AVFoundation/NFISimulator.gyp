{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFIAVFoundation',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls AVFoundation/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'AVFoundation/simulator/NFIAVFoundationLoader.h',
                        'AVFoundation/simulator/NFIAVFoundation.h',
                    ],
                    'xcode_settings': {
                        'ENABLE_BITCODE': 'NO',
                        'INFOPLIST_FILE': 'AVFoundation/Info.plist',
                        'OTHER_LDFLAGS': [
