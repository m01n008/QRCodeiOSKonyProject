...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &kCVPixelFormatContainsGrayscale;
	if (p != NULL) context[@"kCVPixelFormatContainsGrayscale"] = [JSValue valueWithObject: (__bridge id) kCVPixelFormatContainsGrayscale inContext: context];
