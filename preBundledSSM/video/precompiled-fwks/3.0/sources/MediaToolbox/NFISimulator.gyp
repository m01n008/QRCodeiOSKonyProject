{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFIMediaToolbox',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls MediaToolbox/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'MediaToolbox/simulator/NFIMediaToolboxLoader.h',
                        'MediaToolbox/simulator/NFIMediaToolbox.h',
                    ],
                    'xcode_settings': {
                        'ENABLE_BITCODE': 'NO',
                        'INFOPLIST_FILE': 'MediaToolbox/Info.plist',
                        'OTHER_LDFLAGS': [
                            '-weak_framework MediaToolbox',
                        ],
                    },
                },
        ],
