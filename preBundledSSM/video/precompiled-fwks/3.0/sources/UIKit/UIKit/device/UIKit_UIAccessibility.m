...
{
	context[@"UIAccessibilityFocusedElement"] = ^id(UIAccessibilityAssistiveTechnologyIdentifier arg0) {
		return UIAccessibilityFocusedElement(arg0);
	};
	context[@"UIAccessibilityIsVideoAutoplayEnabled"] = ^BOOL() {
		return UIAccessibilityIsVideoAutoplayEnabled();
	};
	context[@"UIAccessibilityButtonShapesEnabled"] = ^BOOL() {
	...
	context[@"UIAccessibilityPrefersCrossFadeTransitions"] = ^BOOL() {
	...
	context[@"UIAccessibilityIsOnOffSwitchLabelsEnabled"] = ^BOOL() {
		return UIAccessibilityIsOnOffSwitchLabelsEnabled();
	};
	context[@"UIAccessibilityShouldDifferentiateWithoutColor"] = ^BOOL() {
...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"UIAccessibilityHearingDeviceEarNone"] = @0U;
	context[@"UIAccessibilityHearingDeviceEarLeft"] = @2U;
	context[@"UIAccessibilityHearingDeviceEarRight"] = @4U;
	context[@"UIAccessibilityHearingDeviceEarBoth"] = @6U;
...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &UIAccessibilityVideoAutoplayStatusDidChangeNotification;
	if (p != NULL) context[@"UIAccessibilityVideoAutoplayStatusDidChangeNotification"] = UIAccessibilityVideoAutoplayStatusDidChangeNotification;
	...
	p = (void*) &UIAccessibilityOnOffSwitchLabelsDidChangeNotification;
	if (p != NULL) context[@"UIAccessibilityOnOffSwitchLabelsDidChangeNotification"] = UIAccessibilityOnOffSwitchLabelsDidChangeNotification;
	...
	p = (void*) &UIAccessibilityShouldDifferentiateWithoutColorDidChangeNotification;
	if (p != NULL) context[@"UIAccessibilityShouldDifferentiateWithoutColorDidChangeNotification"] = UIAccessibilityShouldDifferentiateWithoutColorDidChangeNotification;
	...
	p = (void*) &UIAccessibilityButtonShapesEnabledStatusDidChangeNotification;
	if (p != NULL) context[@"UIAccessibilityButtonShapesEnabledStatusDidChangeNotification"] = UIAccessibilityButtonShapesEnabledStatusDidChangeNotification;
	...
	p = (void*) &UIAccessibilityPrefersCrossFadeTransitionsStatusDidChangeNotification;
	if (p != NULL) context[@"UIAccessibilityPrefersCrossFadeTransitionsStatusDidChangeNotification"] = UIAccessibilityPrefersCrossFadeTransitionsStatusDidChangeNotification;
