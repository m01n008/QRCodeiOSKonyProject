...
{
	context[@"UIContentInsetsReferenceAutomatic"] = @0;
	context[@"UIContentInsetsReferenceNone"] = @1;
	context[@"UIContentInsetsReferenceSafeArea"] = @2;
	context[@"UIContentInsetsReferenceLayoutMargins"] = @3;
	context[@"UIContentInsetsReferenceReadableContent"] = @4;

	context[@"UICollectionLayoutSectionOrthogonalScrollingBehaviorNone"] = @0;
	context[@"UICollectionLayoutSectionOrthogonalScrollingBehaviorContinuous"] = @1;
	context[@"UICollectionLayoutSectionOrthogonalScrollingBehaviorContinuousGroupLeadingBoundary"] = @2;
	context[@"UICollectionLayoutSectionOrthogonalScrollingBehaviorPaging"] = @3;
	context[@"UICollectionLayoutSectionOrthogonalScrollingBehaviorGroupPaging"] = @4;
	context[@"UICollectionLayoutSectionOrthogonalScrollingBehaviorGroupPagingCentered"] = @5;
