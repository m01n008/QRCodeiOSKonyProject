...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"UITouchPhaseRegionEntered"] = @5;
	context[@"UITouchPhaseRegionMoved"] = @6;
	context[@"UITouchPhaseRegionExited"] = @7;
	...
	context[@"UITouchTypePencil"] = @2;
	context[@"UITouchTypeStylus"] = @2;
	context[@"UITouchTypeIndirectPointer"] = @3;
