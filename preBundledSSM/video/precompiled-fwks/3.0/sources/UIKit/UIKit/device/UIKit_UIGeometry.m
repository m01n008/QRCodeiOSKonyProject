...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"UIAxisNeither"] = @0U;
	context[@"UIAxisHorizontal"] = @1U;
	context[@"UIAxisVertical"] = @2U;
	context[@"UIAxisBoth"] = @3U;

	context[@"NSDirectionalRectEdgeNone"] = @0U;
	context[@"NSDirectionalRectEdgeTop"] = @1U;
	context[@"NSDirectionalRectEdgeLeading"] = @2U;
	context[@"NSDirectionalRectEdgeBottom"] = @4U;
	context[@"NSDirectionalRectEdgeTrailing"] = @8U;
	context[@"NSDirectionalRectEdgeAll"] = @15U;

	context[@"UIDirectionalRectEdgeNone"] = @0U;
	context[@"UIDirectionalRectEdgeTop"] = @1U;
	context[@"UIDirectionalRectEdgeLeading"] = @2U;
	context[@"UIDirectionalRectEdgeBottom"] = @4U;
	context[@"UIDirectionalRectEdgeTrailing"] = @8U;
	context[@"UIDirectionalRectEdgeAll"] = @15U;

	context[@"NSRectAlignmentNone"] = @0;
	context[@"NSRectAlignmentTop"] = @1;
	context[@"NSRectAlignmentTopLeading"] = @2;
	context[@"NSRectAlignmentLeading"] = @3;
	context[@"NSRectAlignmentBottomLeading"] = @4;
	context[@"NSRectAlignmentBottom"] = @5;
	context[@"NSRectAlignmentBottomTrailing"] = @6;
	context[@"NSRectAlignmentTrailing"] = @7;
	context[@"NSRectAlignmentTopTrailing"] = @8;
