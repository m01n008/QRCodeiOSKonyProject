...
{
	context[@"UICellAccessoryDisplayedAlways"] = @0;
	context[@"UICellAccessoryDisplayedWhenEditing"] = @1;
	context[@"UICellAccessoryDisplayedWhenNotEditing"] = @2;

	context[@"UICellAccessoryOutlineDisclosureStyleAutomatic"] = @0;
	context[@"UICellAccessoryOutlineDisclosureStyleHeader"] = @1;
	context[@"UICellAccessoryOutlineDisclosureStyleCell"] = @2;

	context[@"UICellAccessoryPlacementLeading"] = @0;
	context[@"UICellAccessoryPlacementTrailing"] = @1;
