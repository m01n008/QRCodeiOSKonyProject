...
@implementation UITextInputPasswordRules (Exports)
...
{
	class_addProtocol([UITextInputPasswordRules class], @protocol(UITextInputPasswordRulesInstanceExports));
	class_addProtocol([UITextInputPasswordRules class], @protocol(UITextInputPasswordRulesClassExports));
}
...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &UITextContentTypeNewPassword;
	if (p != NULL) context[@"UITextContentTypeNewPassword"] = UITextContentTypeNewPassword;
	...
	p = (void*) &UITextContentTypeOneTimeCode;
	if (p != NULL) context[@"UITextContentTypeOneTimeCode"] = UITextContentTypeOneTimeCode;
