...
{
	context[@"UIVibrancyEffectStyleLabel"] = @0L;
	context[@"UIVibrancyEffectStyleSecondaryLabel"] = @1L;
	context[@"UIVibrancyEffectStyleTertiaryLabel"] = @2L;
	context[@"UIVibrancyEffectStyleQuaternaryLabel"] = @3L;
	context[@"UIVibrancyEffectStyleFill"] = @4L;
	context[@"UIVibrancyEffectStyleSecondaryFill"] = @5L;
	context[@"UIVibrancyEffectStyleTertiaryFill"] = @6L;
	context[@"UIVibrancyEffectStyleSeparator"] = @7L;
