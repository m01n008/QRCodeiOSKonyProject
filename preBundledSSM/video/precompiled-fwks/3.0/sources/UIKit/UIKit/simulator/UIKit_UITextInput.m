...
static void addProtocols()
{
	...
	class_addProtocol([UITextPlaceholder class], @protocol(UITextPlaceholderInstanceExports));
	class_addProtocol([UITextPlaceholder class], @protocol(UITextPlaceholderClassExports));
...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"UITextAlternativeStyleNone"] = @0L;
	context[@"UITextAlternativeStyleLowConfidence"] = @1L;
...
static void registerGlobalConstants(JSContext* context)
{
	...
	p = (void*) &UITextWritingDirectionRightToLeft;
	if (p != NULL) context[@"UITextWritingDirectionRightToLeft"] = @(UITextWritingDirectionRightToLeft);
	p = (void*) &UITextWritingDirectionLeftToRight;
	if (p != NULL) context[@"UITextWritingDirectionLeftToRight"] = @(UITextWritingDirectionLeftToRight);
	...
	p = (void*) &UITextWritingDirectionNatural;
	if (p != NULL) context[@"UITextWritingDirectionNatural"] = @(UITextWritingDirectionNatural);
}
