...
{
	context[@"UIDocumentBrowserActionAvailabilityMenu"] = @1L;
	context[@"UIDocumentBrowserActionAvailabilityNavigationBar"] = @2L;
...
void load_UIKit_UIDocumentBrowserAction_symbols(JSContext* context)
{
    addProtocols();
