...
{
	context[@"UIScrollTypeDiscrete"] = @0UL;
	context[@"UIScrollTypeContinuous"] = @1UL;

	context[@"UIScrollTypeMaskDiscrete"] = @1L;
	context[@"UIScrollTypeMaskContinuous"] = @2L;
	context[@"UIScrollTypeMaskAll"] = @3L;
