...
static void addProtocols()
{
	...
	class_addProtocol([NSLayoutYAxisAnchor class], @protocol(NSLayoutYAxisAnchorUIViewDynamicSystemSpacingSupportCategoryInstanceExports));
	class_addProtocol([NSLayoutYAxisAnchor class], @protocol(NSLayoutYAxisAnchorUIViewDynamicSystemSpacingSupportCategoryClassExports));
	...
	class_addProtocol([NSLayoutXAxisAnchor class], @protocol(NSLayoutXAxisAnchorUIViewDynamicSystemSpacingSupportCategoryInstanceExports));
	class_addProtocol([NSLayoutXAxisAnchor class], @protocol(NSLayoutXAxisAnchorUIViewDynamicSystemSpacingSupportCategoryClassExports));
}
