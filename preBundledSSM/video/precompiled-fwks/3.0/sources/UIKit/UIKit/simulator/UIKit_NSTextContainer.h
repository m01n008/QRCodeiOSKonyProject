...
@protocol NSTextContainerInstanceExports<JSExport, NSSecureCodingInstanceExports_, NSTextLayoutOrientationProviderInstanceExports_>
...
@end
@protocol NSTextContainerClassExports<JSExport, NSSecureCodingClassExports_, NSTextLayoutOrientationProviderClassExports_>
@end
