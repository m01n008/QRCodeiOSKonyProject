...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"UIRectCornerTopLeft"] = @1UL;
	context[@"UIRectCornerTopRight"] = @2UL;
	context[@"UIRectCornerBottomLeft"] = @4UL;
	context[@"UIRectCornerBottomRight"] = @8UL;
	context[@"UIRectCornerAllCorners"] = @-1UL;

	context[@"UIAxisNeither"] = @0UL;
	context[@"UIAxisHorizontal"] = @1UL;
	context[@"UIAxisVertical"] = @2UL;
	context[@"UIAxisBoth"] = @3UL;

	context[@"NSDirectionalRectEdgeNone"] = @0UL;
	context[@"NSDirectionalRectEdgeTop"] = @1UL;
	context[@"NSDirectionalRectEdgeLeading"] = @2UL;
	context[@"NSDirectionalRectEdgeBottom"] = @4UL;
	context[@"NSDirectionalRectEdgeTrailing"] = @8UL;
	context[@"NSDirectionalRectEdgeAll"] = @15UL;

	context[@"UIDirectionalRectEdgeNone"] = @0UL;
	context[@"UIDirectionalRectEdgeTop"] = @1UL;
	context[@"UIDirectionalRectEdgeLeading"] = @2UL;
	context[@"UIDirectionalRectEdgeBottom"] = @4UL;
	context[@"UIDirectionalRectEdgeTrailing"] = @8UL;
	context[@"UIDirectionalRectEdgeAll"] = @15UL;

	context[@"NSRectAlignmentNone"] = @0L;
	context[@"NSRectAlignmentTop"] = @1L;
	context[@"NSRectAlignmentTopLeading"] = @2L;
	context[@"NSRectAlignmentLeading"] = @3L;
	context[@"NSRectAlignmentBottomLeading"] = @4L;
	context[@"NSRectAlignmentBottom"] = @5L;
	context[@"NSRectAlignmentBottomTrailing"] = @6L;
	context[@"NSRectAlignmentTrailing"] = @7L;
	context[@"NSRectAlignmentTopTrailing"] = @8L;
