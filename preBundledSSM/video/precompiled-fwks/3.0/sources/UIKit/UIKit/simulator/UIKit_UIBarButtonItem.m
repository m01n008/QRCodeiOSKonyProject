...
{
	id resultVal__;
	resultVal__ = [[self initWithTitle: title menu: menu ] autorelease];
	return resultVal__;
}
...
{
	id resultVal__;
	resultVal__ = [[self initWithBarButtonSystemItem: systemItem primaryAction: primaryAction ] autorelease];
	return resultVal__;
}
...
{
	id resultVal__;
	resultVal__ = [[self initWithImage: image menu: menu ] autorelease];
	return resultVal__;
}
-(id) jsinitWithPrimaryAction: (UIAction *) primaryAction 
{
	id resultVal__;
	resultVal__ = [[self initWithPrimaryAction: primaryAction ] autorelease];
	return resultVal__;
}
-(id) jsinitWithBarButtonSystemItem: (UIBarButtonSystemItem) systemItem menu: (UIMenu *) menu 
{
	id resultVal__;
	resultVal__ = [[self initWithBarButtonSystemItem: systemItem menu: menu ] autorelease];
	return resultVal__;
}
...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"UIBarButtonSystemItemClose"] = @24L;
