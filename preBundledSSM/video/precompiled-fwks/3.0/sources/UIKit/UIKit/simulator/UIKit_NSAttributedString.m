...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"NSUnderlineStylePatternSolid"] = @0L;
	context[@"NSUnderlineStylePatternDot"] = @256L;
	context[@"NSUnderlineStylePatternDash"] = @512L;
	context[@"NSUnderlineStylePatternDashDot"] = @768L;
	context[@"NSUnderlineStylePatternDashDotDot"] = @1024L;
	context[@"NSUnderlineStyleByWord"] = @32768L;

	context[@"NSWritingDirectionEmbedding"] = @0L;
	context[@"NSWritingDirectionOverride"] = @2L;

	context[@"NSTextScalingStandard"] = @0L;
	context[@"NSTextScalingiOS"] = @1L;
