...
@implementation UIActivityViewController (UIActivityViewControllerUIActivityItemsConfigurationCategoryExports)
-(id) jsinitWithActivityItemsConfiguration: (id) activityItemsConfiguration 
{
	id resultVal__;
	resultVal__ = [[self initWithActivityItemsConfiguration: activityItemsConfiguration ] autorelease];
	return resultVal__;
}
@end
...
{
	class_addProtocol([UIActivityViewController class], @protocol(UIActivityViewControllerUIActivityItemsConfigurationCategoryInstanceExports));
	class_addProtocol([UIActivityViewController class], @protocol(UIActivityViewControllerUIActivityItemsConfigurationCategoryClassExports));
