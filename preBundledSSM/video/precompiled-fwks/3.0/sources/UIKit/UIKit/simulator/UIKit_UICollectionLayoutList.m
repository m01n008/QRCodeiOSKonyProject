...
{
	context[@"UICollectionLayoutListAppearancePlain"] = @0L;
	context[@"UICollectionLayoutListAppearanceGrouped"] = @1L;
	context[@"UICollectionLayoutListAppearanceInsetGrouped"] = @2L;
	context[@"UICollectionLayoutListAppearanceSidebar"] = @3L;
	context[@"UICollectionLayoutListAppearanceSidebarPlain"] = @4L;

	context[@"UICollectionLayoutListHeaderModeNone"] = @0L;
	context[@"UICollectionLayoutListHeaderModeSupplementary"] = @1L;
	context[@"UICollectionLayoutListHeaderModeFirstItemInSection"] = @2L;

	context[@"UICollectionLayoutListFooterModeNone"] = @0L;
	context[@"UICollectionLayoutListFooterModeSupplementary"] = @1L;
