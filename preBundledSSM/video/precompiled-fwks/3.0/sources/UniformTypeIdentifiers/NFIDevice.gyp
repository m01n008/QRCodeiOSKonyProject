{
    ...
    'targets': [
        ...
        },
        {
                    ...
                    'sources': [
                        '<!@(ls UniformTypeIdentifiers/device/*)',
                    ],
                    'mac_framework_headers':[
                        'UniformTypeIdentifiers/device/NFIUniformTypeIdentifiersLoader.h',
                        'UniformTypeIdentifiers/device/NFIUniformTypeIdentifiers.h',
                    ],
                    'xcode_settings': {
                        'ENABLE_BITCODE': 'NO',
