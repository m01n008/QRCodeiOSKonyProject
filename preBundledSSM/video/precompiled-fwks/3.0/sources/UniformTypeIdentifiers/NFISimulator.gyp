{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFIUniformTypeIdentifiers',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls UniformTypeIdentifiers/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'UniformTypeIdentifiers/simulator/NFIUniformTypeIdentifiersLoader.h',
                        'UniformTypeIdentifiers/simulator/NFIUniformTypeIdentifiers.h',
                    ],
                    'xcode_settings': {
                        'ENABLE_BITCODE': 'NO',
                        'INFOPLIST_FILE': 'UniformTypeIdentifiers/Info.plist',
                        'OTHER_LDFLAGS': [
