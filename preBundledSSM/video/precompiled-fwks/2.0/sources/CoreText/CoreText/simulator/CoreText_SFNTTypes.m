...
-(sfntFontDescriptor) tosfntFontDescriptor {
	return (sfntFontDescriptor) {
		(FourCharCode) [self[@"name"] toUInt32],
		(Fixed) [self[@"value"] toInt32],
	};
}
...
-(sfntDirectoryEntry) tosfntDirectoryEntry {
	return (sfntDirectoryEntry) {
		(FourCharCode) [self[@"tableTag"] toUInt32],
		(UInt32) [self[@"checkSum"] toUInt32],
		(UInt32) [self[@"offset"] toUInt32],
		(UInt32) [self[@"length"] toUInt32],
	};
}
...
-(sfntVariationAxis) tosfntVariationAxis {
	return (sfntVariationAxis) {
		(FourCharCode) [self[@"axisTag"] toUInt32],
		(Fixed) [self[@"minValue"] toInt32],
		(Fixed) [self[@"defaultValue"] toInt32],
		(Fixed) [self[@"maxValue"] toInt32],
...
-(sfntFeatureName) tosfntFeatureName {
	return (sfntFeatureName) {
		...
		(SInt32) [self[@"offsetToSettings"] toInt32],
