...
@end
@protocol AVMetadataGroupAVMetadataGroupIdentificationCategoryInstanceExports<JSExport>
@property (readonly,nonatomic) NSString * classifyingLabel;
@property (readonly,nonatomic) NSString * uniqueID;
@end
@protocol AVMetadataGroupAVMetadataGroupIdentificationCategoryClassExports<JSExport>
@end
