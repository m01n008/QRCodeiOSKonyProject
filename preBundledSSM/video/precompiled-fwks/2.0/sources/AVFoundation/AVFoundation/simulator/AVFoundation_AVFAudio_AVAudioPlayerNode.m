...
{
	context[@"AVAudioPlayerNodeBufferLoops"] = @1UL;
	context[@"AVAudioPlayerNodeBufferInterrupts"] = @2UL;
	context[@"AVAudioPlayerNodeBufferInterruptsAtLoop"] = @4UL;

	context[@"AVAudioPlayerNodeCompletionDataConsumed"] = @0L;
	context[@"AVAudioPlayerNodeCompletionDataRendered"] = @1L;
	context[@"AVAudioPlayerNodeCompletionDataPlayedBack"] = @2L;
