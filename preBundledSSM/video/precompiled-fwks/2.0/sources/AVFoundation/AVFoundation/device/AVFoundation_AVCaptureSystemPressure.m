...
{
	context[@"AVCaptureSystemPressureFactorNone"] = @0U;
	context[@"AVCaptureSystemPressureFactorSystemTemperature"] = @1U;
	context[@"AVCaptureSystemPressureFactorPeakPower"] = @2U;
	context[@"AVCaptureSystemPressureFactorDepthModuleTemperature"] = @4U;
