...
{
	void* p; p = NULL;
	p = (void*) &AVAssetWriterInputMediaDataLocationBeforeMainMediaDataNotInterleaved;
	if (p != NULL) context[@"AVAssetWriterInputMediaDataLocationBeforeMainMediaDataNotInterleaved"] = AVAssetWriterInputMediaDataLocationBeforeMainMediaDataNotInterleaved;
	p = (void*) &AVAssetWriterInputMediaDataLocationInterleavedWithMainMediaData;
	if (p != NULL) context[@"AVAssetWriterInputMediaDataLocationInterleavedWithMainMediaData"] = AVAssetWriterInputMediaDataLocationInterleavedWithMainMediaData;
}
