{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFIQuartzCore',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls QuartzCore/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'QuartzCore/simulator/NFIQuartzCoreLoader.h',
                        'QuartzCore/simulator/NFIQuartzCore.h',
                    ],
                    'xcode_settings': {
                        'INFOPLIST_FILE': 'QuartzCore/Info.plist',
                        'OTHER_LDFLAGS': [
