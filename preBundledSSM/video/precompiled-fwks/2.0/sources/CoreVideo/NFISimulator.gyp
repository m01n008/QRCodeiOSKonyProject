{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFICoreVideo',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls CoreVideo/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'CoreVideo/simulator/NFICoreVideoLoader.h',
                        'CoreVideo/simulator/NFICoreVideo.h',
                    ],
                    'xcode_settings': {
                        'INFOPLIST_FILE': 'CoreVideo/Info.plist',
                        'OTHER_LDFLAGS': [
