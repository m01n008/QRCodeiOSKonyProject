{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFIAudioToolbox',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls AudioToolbox/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'AudioToolbox/simulator/NFIAudioToolboxLoader.h',
                        'AudioToolbox/simulator/NFIAudioToolbox.h',
                    ],
                    'xcode_settings': {
                        'INFOPLIST_FILE': 'AudioToolbox/Info.plist',
                        'OTHER_LDFLAGS': [
