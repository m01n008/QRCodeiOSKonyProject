{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFICoreMedia',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls CoreMedia/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'CoreMedia/simulator/NFICoreMediaLoader.h',
                        'CoreMedia/simulator/NFICoreMedia.h',
                    ],
                    'xcode_settings': {
                        'INFOPLIST_FILE': 'CoreMedia/Info.plist',
                        'OTHER_LDFLAGS': [
