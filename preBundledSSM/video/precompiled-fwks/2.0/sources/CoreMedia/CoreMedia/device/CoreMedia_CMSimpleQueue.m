...
{
	context[@"kCMSimpleQueueError_AllocationFailed"] = @-12770L;
	context[@"kCMSimpleQueueError_RequiredParameterMissing"] = @-12771L;
	context[@"kCMSimpleQueueError_ParameterOutOfRange"] = @-12772L;
	context[@"kCMSimpleQueueError_QueueIsFull"] = @-12773L;
