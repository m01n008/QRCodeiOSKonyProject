...
{
	context[@"kCMBufferQueueError_AllocationFailed"] = @-12760L;
	context[@"kCMBufferQueueError_RequiredParameterMissing"] = @-12761L;
	context[@"kCMBufferQueueError_InvalidCMBufferCallbacksStruct"] = @-12762L;
	context[@"kCMBufferQueueError_EnqueueAfterEndOfData"] = @-12763L;
	context[@"kCMBufferQueueError_QueueIsFull"] = @-12764L;
	context[@"kCMBufferQueueError_BadTriggerDuration"] = @-12765L;
	context[@"kCMBufferQueueError_CannotModifyQueueFromTriggerCallback"] = @-12766L;
	context[@"kCMBufferQueueError_InvalidTriggerCondition"] = @-12767L;
	context[@"kCMBufferQueueError_InvalidTriggerToken"] = @-12768L;
	context[@"kCMBufferQueueError_InvalidBuffer"] = @-12769L;
