{
    ...
    'targets': [
        ...
        {
                    'target_name': 'NFICoreAudio',
                    'type': 'shared_library',
                    'dependencies': ['NFIUtility'],
                    'sources': [
                        '<!@(ls CoreAudio/simulator/*)',
                    ],
                    'mac_framework_headers':[
                        'CoreAudio/simulator/NFICoreAudioLoader.h',
                        'CoreAudio/simulator/NFICoreAudio.h',
                    ],
                    'xcode_settings': {
                        'INFOPLIST_FILE': 'CoreAudio/Info.plist',
                        'OTHER_LDFLAGS': [
