...
static void registerEnumConstants(JSContext* context)
{
	...
	context[@"kAudioFormatFLAC"] = @1718378851UL;
	context[@"kAudioFormatOpus"] = @1869641075UL;
	...
	context[@"kAudioChannelLabel_HOA_ACN"] = @500UL;
	context[@"kAudioChannelLabel_HOA_ACN_0"] = @131072UL;
	context[@"kAudioChannelLabel_HOA_ACN_1"] = @131073UL;
	context[@"kAudioChannelLabel_HOA_ACN_2"] = @131074UL;
	context[@"kAudioChannelLabel_HOA_ACN_3"] = @131075UL;
	context[@"kAudioChannelLabel_HOA_ACN_4"] = @131076UL;
	context[@"kAudioChannelLabel_HOA_ACN_5"] = @131077UL;
	context[@"kAudioChannelLabel_HOA_ACN_6"] = @131078UL;
	context[@"kAudioChannelLabel_HOA_ACN_7"] = @131079UL;
	context[@"kAudioChannelLabel_HOA_ACN_8"] = @131080UL;
	context[@"kAudioChannelLabel_HOA_ACN_9"] = @131081UL;
	context[@"kAudioChannelLabel_HOA_ACN_10"] = @131082UL;
	context[@"kAudioChannelLabel_HOA_ACN_11"] = @131083UL;
	context[@"kAudioChannelLabel_HOA_ACN_12"] = @131084UL;
	context[@"kAudioChannelLabel_HOA_ACN_13"] = @131085UL;
	context[@"kAudioChannelLabel_HOA_ACN_14"] = @131086UL;
	context[@"kAudioChannelLabel_HOA_ACN_15"] = @131087UL;
	context[@"kAudioChannelLabel_HOA_ACN_65024"] = @196096UL;
	...
	context[@"kAudioChannelLayoutTag_HOA_ACN_SN3D"] = @12451840UL;
	context[@"kAudioChannelLayoutTag_HOA_ACN_N3D"] = @12517376UL;
