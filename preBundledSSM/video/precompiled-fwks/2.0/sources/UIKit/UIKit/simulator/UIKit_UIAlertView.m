...
{
	context[@"UIAlertViewStyleDefault"] = @0L;
	context[@"UIAlertViewStyleSecureTextInput"] = @1L;
	context[@"UIAlertViewStylePlainTextInput"] = @2L;
	context[@"UIAlertViewStyleLoginAndPasswordInput"] = @3L;
