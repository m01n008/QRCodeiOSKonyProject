...
{
	context[@"UIAccessibilityCustomRotorDirectionPrevious"] = @0L;
	context[@"UIAccessibilityCustomRotorDirectionNext"] = @1L;

	context[@"UIAccessibilityCustomSystemRotorTypeNone"] = @0L;
	context[@"UIAccessibilityCustomSystemRotorTypeLink"] = @1L;
	context[@"UIAccessibilityCustomSystemRotorTypeVisitedLink"] = @2L;
	context[@"UIAccessibilityCustomSystemRotorTypeHeading"] = @3L;
	context[@"UIAccessibilityCustomSystemRotorTypeHeadingLevel1"] = @4L;
	context[@"UIAccessibilityCustomSystemRotorTypeHeadingLevel2"] = @5L;
	context[@"UIAccessibilityCustomSystemRotorTypeHeadingLevel3"] = @6L;
	context[@"UIAccessibilityCustomSystemRotorTypeHeadingLevel4"] = @7L;
	context[@"UIAccessibilityCustomSystemRotorTypeHeadingLevel5"] = @8L;
	context[@"UIAccessibilityCustomSystemRotorTypeHeadingLevel6"] = @9L;
	context[@"UIAccessibilityCustomSystemRotorTypeBoldText"] = @10L;
	context[@"UIAccessibilityCustomSystemRotorTypeItalicText"] = @11L;
	context[@"UIAccessibilityCustomSystemRotorTypeUnderlineText"] = @12L;
	context[@"UIAccessibilityCustomSystemRotorTypeMisspelledWord"] = @13L;
	context[@"UIAccessibilityCustomSystemRotorTypeImage"] = @14L;
	context[@"UIAccessibilityCustomSystemRotorTypeTextField"] = @15L;
	context[@"UIAccessibilityCustomSystemRotorTypeTable"] = @16L;
	context[@"UIAccessibilityCustomSystemRotorTypeList"] = @17L;
	context[@"UIAccessibilityCustomSystemRotorTypeLandmark"] = @18L;
