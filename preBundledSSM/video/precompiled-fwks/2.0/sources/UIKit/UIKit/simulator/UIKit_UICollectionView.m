...
{
	context[@"UICollectionViewScrollPositionNone"] = @0UL;
	context[@"UICollectionViewScrollPositionTop"] = @1UL;
	context[@"UICollectionViewScrollPositionCenteredVertically"] = @2UL;
	context[@"UICollectionViewScrollPositionBottom"] = @4UL;
	context[@"UICollectionViewScrollPositionLeft"] = @8UL;
	context[@"UICollectionViewScrollPositionCenteredHorizontally"] = @16UL;
	context[@"UICollectionViewScrollPositionRight"] = @32UL;

	context[@"UICollectionViewReorderingCadenceImmediate"] = @0L;
	context[@"UICollectionViewReorderingCadenceFast"] = @1L;
	context[@"UICollectionViewReorderingCadenceSlow"] = @2L;

	context[@"UICollectionViewDropIntentUnspecified"] = @0L;
	context[@"UICollectionViewDropIntentInsertAtDestinationIndexPath"] = @1L;
	context[@"UICollectionViewDropIntentInsertIntoDestinationIndexPath"] = @2L;
