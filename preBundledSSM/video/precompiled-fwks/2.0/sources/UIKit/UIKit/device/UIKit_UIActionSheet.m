...
{
	context[@"UIActionSheetStyleAutomatic"] = @-1;
	context[@"UIActionSheetStyleDefault"] = @0;
	context[@"UIActionSheetStyleBlackTranslucent"] = @2;
	context[@"UIActionSheetStyleBlackOpaque"] = @1;
