...
@property(nonatomic, readwrite) CGRect pFrame;
@property (nonatomic) BOOL hasShadow;

+ (CustomBadge*) customBadgeWithString:(NSString *)badgeString andFrame:(CGRect) frame;
+ (CustomBadge*) customBadgeWithString:(NSString *)badgeString withStringColor:(UIColor*)stringColor withInsetColor:(UIColor*)insetColor withBadgeFrame:(BOOL)badgeFrameYesNo withBadgeFrameColor:(UIColor*)frameColor withScale:(CGFloat)scale withShining:(BOOL)shining withFrame:(CGRect) frame;
+(CGSize) suggestSizeForText:(NSString*)text;
+(CGRect) suggestSizeForText:(NSString *)text withParentViewFrame:(CGRect) frame;

- (id) initWithString:(NSString *)badgeString withStringColor:(UIColor*)stringColor withInsetColor:(UIColor*)insetColor withBadgeFrame:(BOOL)badgeFrameYesNo withBadgeFrameColor:(UIColor*)frameColor withScale:(CGFloat)scale withShining:(BOOL)shining withFrame:(CGRect) frame;

- (void) autoBadgeSizeWithString:(NSString *)badgeString;
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event;
+ (UIFont *)getBadgeFontOfSize:(CGFloat)size;
