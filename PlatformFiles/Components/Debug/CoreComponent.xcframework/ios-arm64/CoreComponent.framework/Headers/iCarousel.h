...
@class KonyGestureRecognizer;
@interface iCarousel : UIView
@property(assign,readwrite, nonatomic, nullable) KonyGestureRecognizer *gRecognizer;
...
- (nullable UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSUInteger)index reusingView:(nullable UIView *)view;

@optional
//Issue(Conflicting types)
- (NSUInteger)numberOfPlaceholdersInCarousel:(iCarousel *)carousel;
- (UIView *)carousel:(iCarousel *)carousel placeholderViewAtIndex:(NSInteger)index reusingView:(nullable UIView *)view;
- (NSInteger)getNumberOfVisibleItems;
